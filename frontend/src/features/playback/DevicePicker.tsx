 ...
 * of the trigger button (which lives in PlayerCard or MiniBar).
 */
  ...
  return (
    ...
    >
      {/* Hidden zero-size anchor. Positioning relative to the real trigger
          button (PlayerCard / MiniBar) is handled by the calling layer passing
          the anchor element; for F7 the popover floats near the bottom-right of
          the viewport, which is close enough for the picker UX. */}
      <Popover.Target>
