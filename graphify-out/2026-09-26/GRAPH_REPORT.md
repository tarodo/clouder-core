...
## Corpus Check
- 2041 files · ~1,827,103 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10751 nodes · 21282 edges · 570 communities (524 shown, 46 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 1026 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0b773a35`
...
2. `log_event()` - 127 edges
3. `server` - 99 edges
4. `api()` - 97 edges
5. `tokenStore` - 89 edges
6. `DataAPIClient` - 88 edges
7. `PlaylistsRepository` - 81 edges
8. `ValidationError` - 76 edges
9. `ClouderRepository` - 73 edges
...
## Communities (570 total, 46 thin omitted)

### Community 0 - "Playlists UI"
Cohesion: 0.04
Nodes (61): BadQueryParamError, ConfirmOverwriteRequiredError, CoverMissingError, CoverTooLargeError, CurationError, InactiveBucketError, InactiveStagingFinalizeError, InvalidMatchError (+53 more)
...
Cohesion: 0.06
Nodes (106): Any, _build_repository(), _default_config(), _extract_user_id(), handle_get_auto_config(), handle_put_auto_config(), _options(), HTTP handlers for auto-enrichment config (artists). (+98 more)
...
Cohesion: 0.07
Nodes (22): FinalizeBlockerRow(), FinalizeBlockerRowProps, BlockerVariantProps, ConfirmVariantProps, ErrorCtx, FinalizeModal(), handleFinalizeError(), Phase (+14 more)

### Community 5 - "KMS Envelope & Auth Crypto"
Cohesion: 0.08
Nodes (34): BaseSettings, _build_alembic_database_url(), lambda_handler(), Lambda handler that executes Alembic migrations against Aurora., _rds_client(), _read_secret(), MigrationCommand, ArtistEnrichmentWorkerSettings (+26 more)

### Community 6 - "Library Artist/Label UI"
Cohesion: 0.08
Nodes (24): CurateSkeleton(), clearLastCurateLocation(), CurateLocation, isStaleLocation(), readLastCurateLocation(), readLastCurateStyle(), readStorage(), Storage (+16 more)
...
Cohesion: 0.07
Nodes (36): AddToPlaylistSubmenu(), AddToPlaylistSubmenuProps, HOTKEY_LABELS, PlayerPanelPlaylistCloud(), PlayerPanelPlaylistCloudProps, AddTracksInput, useAddTracksToPlaylist(), useDeletePlaylist() (+28 more)

### Community 9 - "Bucket Player UI"
Cohesion: 0.06
Nodes (34): ArtistHistoryCell, ArtistHistoryResponse, BacklogArtist, BacklogResponse, EnrichBody, EnrichmentOptions, RunCell, RunDetail (+26 more)

### Community 10 - "Curation Error Types"
Cohesion: 0.11
Nodes (27): Path, main(), splitlab CLI: pull-sample | run | report., load_settings(), _parse_env(), Settings: .env loader (no python-dotenv dep) + fixed experiment constants., Settings, _filled() (+19 more)

### Community 11 - "Playlist/Bucket Track Rows"
Cohesion: 0.05
Nodes (28): ApiError, { removeAsync }, TRACK, TrackRowActions(), TrackRowActionsProps, AddTrackTagInput, MutationContext, AddTrackToCategoryInput (+20 more)
...
Cohesion: 0.03
Nodes (65): Canonicalizer, _chunks(), _identity_cmd(), _payload_hash(), Canonicalization workflow for Beatport entities., _source_entity_cmd(), CanonicalizationResult, RunStatus (+57 more)
...
Cohesion: 0.02
Nodes (72): tokenStore, CategoriesList(), CategoriesListProps, CategoryRow(), CategoryRowProps, MyStylesSection(), categoriesByStyleKey(), Category (+64 more)

### Community 18 - "Vendor Stubs (Apple/Deezer)"
Cohesion: 0.02
Nodes (101): call(), CallOptions, ensureOk(), PlayArgs, SeekArgs, spotifyApi, TransferArgs, Action (+93 more)
...
Cohesion: 0.12
Nodes (16): FakeDataApi, FakeTxDataApi, UserStylesRepository: per-user style selection reads., FakeDataApi plus a transaction() context manager., Minimal stub: records (sql, params) per call, returns scripted rows., test_count_selection_counts_pref_rows_only(), test_list_all_keeps_created_at_desc_order(), test_list_catalog_projects_selected_and_position() (+8 more)

### Community 23 - "Storage & Ingest Schemas"
Cohesion: 0.04
Nodes (41): ArtistEnrichmentMessage, EnrichArtistInput, EnrichArtistsRequestIn, SQS message schema for artist enrichment (HTTP request models added in 1B)., Body of one SQS message — one per artist, one Lambda invocation.      The disamb, POST /admin/artists/enrich body., AISignal, GroundTruth (+33 more)
...
Cohesion: 0.19
Nodes (13): DriftBadge(), DriftTarget, PlaylistRow(), PlaylistRowProps, PlaylistsTable(), PlaylistsTableProps, StatusBadge(), StatusBadgeProps (+5 more)
...
Cohesion: 0.07
Nodes (27): AddTracksModal(), AddTracksModalProps, mutateAsync, PublishButton(), PublishButtonProps, mutateAsync, playlist, RESULT (+19 more)
...
Cohesion: 0.18
Nodes (17): _beatport_track_row(), _make_data_api(), _make_repo(), list_tracks with tags_repo attaches artists, label, bpm, mix_name,     spotify_r, When tags_repo is omitted, tags field defaults to empty tuple., test_create_inserts_row_and_returns_playlist(), test_create_raises_limit_reached_at_200(), test_get_filters_soft_deleted() (+9 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (62): AppleExporter, Apple export stub — raises VendorDisabledError until implemented., AppleLookup, Apple lookup stub — raises VendorDisabledError until implemented., Application-level errors for the collector Lambda., Raised when a registry lookup cannot be served. The .reason attribute     discri, VendorDisabledError, get_spotify_worker_settings() (+54 more)

### Community 36 - "Community 36"
Cohesion: 0.10
Nodes (19): PublishResultModal(), PublishResultModalProps, playlist, PublishYtMusicButton(), PublishYtMusicButtonProps, mutateAsync, playlist, RESULT (+11 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (50): _build_narrative_prompt(), _filter_parseable(), _highest_confidence_cell(), merge_cells(), _merge_deterministic(), _merge_narrative(), _rank_list_round_robin(), Multi-vendor consensus aggregator for ArtistInfo cells.  The single public entry (+42 more)
...
Cohesion: 0.03
Nodes (94): ArtistsPanel(), PanelArtist, Props, CategoryPlayerPanel(), CategoryPlayerPanelProps, PlayerPanelTagCloud(), PlayerPanelTagCloudProps, PlaylistPlayerPanel() (+86 more)
...
Cohesion: 0.04
Nodes (44): StorageError, CanonicalizationMessage, create_default_s3_client(), S3 persistence for weekly snapshots., S3Storage, _enqueue_spotify_search_after_canonicalization(), _extract_message_attribute(), lambda_handler() (+36 more)
...
Cohesion: 0.06
Nodes (23): DestinationGrid(), DestinationGridProps, ForceToggle(), ForceToggleProps, DIGIT_CODES, BUCKETS, setup(), useCurateHotkeys() (+15 more)
...
Cohesion: 0.09
Nodes (24): AutoEnrichConfigBody, AutoEnrichConfigResponse, AutoEnrichConfigBody, AutoEnrichConfigResponse, EnrichBody, EnrichmentOptions, EnqueueDrawer(), Props (+16 more)
...
Cohesion: 0.26
Nodes (8): date, Tests for Spotify not-found retry repository methods., _repo(), test_count_not_found_applies_date_filters(), test_count_spotify_pending_in_range(), test_find_not_found_applies_date_filters(), test_find_not_found_without_dates_keeps_old_sql(), test_reset_spotify_not_found_counts_returned_rows()
...
Cohesion: 0.13
Nodes (27): VendorMatchMessage, get_vendor_match_settings(), VendorMatchSettings, _process_one(), SQS-triggered worker that matches a canonical track to a vendor., _try_isrc(), _try_metadata(), _candidate() (+19 more)
...
Cohesion: 0.24
Nodes (8): CoverageMatrix(), Props, CoveragePayload, SpotifyWeekStats, useCoverage(), formatSpotifyStats(), AdminCoveragePage(), sample
...
Cohesion: 0.08
Nodes (22): VendorTrackRef, _track_to_ref(), FakeYT, test_isrc_lookup_always_none(), test_metadata_falls_back_to_videos_when_songs_empty(), test_metadata_skips_results_without_video_id(), test_metadata_uses_songs_pass_first(), test_build_query_joins_and_collapses_whitespace() (+14 more)
...
Cohesion: 0.07
Nodes (35): label_v2_facts — facts-discipline prompt: numbers, sources, no guessing., label_v3_app_fields — label_v2_facts plus logo, socials, tagline for app integra, _build_narrative_prompt(), _filter_parseable(), _highest_confidence_cell(), merge_cells(), _merge_deterministic(), _merge_narrative() (+27 more)
...
Cohesion: 0.10
Nodes (23): aggregate(), build_deepseek_client(), build_vendors(), list_fixtures(), _parse_csv(), Merge per-vendor cells in a run into consensus ArtistInfo per fixture., Run the prompts × vendors × fixtures matrix., Build a DeepSeek-pointed OpenAI client + return chosen model. (+15 more)
...
Cohesion: 0.09
Nodes (23): ArtistsListResponse, LabelsListResponse, EntityTabs(), Props, LibraryFilters(), Props, StyleOption, PageHeader() (+15 more)
...
Cohesion: 0.12
Nodes (12): PlaylistLimitReachedError, PlaylistNameConflictError, PlaylistNotFoundError, AppendTracksResult, PlaylistRow, PlaylistTrackRow, Aurora Data API repository for playlists (spec 2026-05-11).  Tenancy: every meth, Per-track YT Music status. matched > needs_review > not_found > pending. (+4 more)
...
Cohesion: 0.06
Nodes (41): SpotifyAuthError, SpotifyUnavailableError, _album_release_sort_key(), Spotify Web API client with Client Credentials auth and retry semantics., Map each Spotify track id to its ordered artist names (batched)., Spotify text search fallback when ISRC lookup returned no items.          Builds, Try ISRCs that differ from the query by ±1, ±2 in the last digit.          Sibli, Search Spotify for a single track by ISRC.          Fetches up to 10 results and (+33 more)

### Community 152 - "Community 152"
Cohesion: 0.03
Nodes (71): ActiveBlocksList(), ActiveBlocksListProps, CountersGrid(), CountersGridProps, CurateSetupPage(), CurateSetupPageProps, HomeSkeleton(), NoStylesEmpty() (+63 more)
...
Cohesion: 0.03
Nodes (76): ArtistSummary, BacklogLabel, BacklogResponse, LabelSummary, RunCell, RunDetail, RunsListResponse, RunSummary (+68 more)
...
Cohesion: 0.08
Nodes (34): reset_settings_cache(), lambda_handler(), _event(), FakeS3Client, A batch that dies after claiming must hand its rows back.  Claiming stamps `spot, The stamp has to land before the search, not after it., _setup(), test_claim_is_stamped_before_the_upstream_call() (+26 more)
...
Cohesion: 0.16
Nodes (28): _base_payload(), test_blank_bp_token_is_rejected(), test_both_period_fields_present_is_valid(), test_extra_fields_forbidden(), test_minimal_payload_is_valid(), test_only_period_end_is_rejected(), test_only_period_start_is_rejected(), test_period_end_before_start_is_rejected() (+20 more)
...
Cohesion: 0.07
Nodes (22): loadSpotifySdk(), __resetSdkLoaderForTests(), waitForReady(), makeClient(), makeStubAuth(), renderApp(), renderAppWithRouter(), FakeSpotifyPlayer (+14 more)
...
Cohesion: 0.11
Nodes (13): SpotifySearchResult, EnrichResult, SpotifyEnricher, test_enrich_result_required_fields(), _FakeLookup, Unit tests for SpotifyEnricher (release_type extraction)., test_enricher_implements_protocol(), test_enricher_rejects_wrong_entity_type() (+5 more)
...
Cohesion: 0.40
Nodes (11): SessionRow, _event(), _refresh_jwt(), _stored_session(), test_refresh_happy_path_rotates_tokens(), test_refresh_missing_cookie_returns_401(), test_refresh_replay_revokes_session_family(), test_refresh_session_not_found_returns_401() (+3 more)
...
Cohesion: 0.04
Nodes (57): ArtistDetail, LabelDetail, ArtistChannelLinks(), ArtistDetailHeader(), Props, ArtistOverviewTab(), ArtistPreferenceButtons(), Props (+49 more)

### Community 235 - "Community 235"
Cohesion: 0.18
Nodes (15): _build_repository(), lambda_handler(), SQS-driven Lambda that collects comments for one video per record., Collect from the primary video; on CommentsDisabledError, fall back to up to, _resolve_and_collect(), _utc_now(), _build_youtube(), _enabled_platforms() (+7 more)
...
Cohesion: 0.13
Nodes (20): api(), ApiInit, notifyAuthFailure(), RefreshResponse, tryRefreshOnce(), SpotifyNotFoundTable(), artistDetailKey(), useArtistDetail() (+12 more)
...
Cohesion: 0.16
Nodes (20): test_run_returns_error_when_no_tool_use(), test_run_exception_path(), _make_grounding_chunk(), _mock_response(), Tests for GeminiFlashAdapter using injected fake clients., 503 UNAVAILABLE errors are retried with exponential backoff., Quota errors are retried; success on the third attempt counts as ok., When grounding_metadata has no URLs, copy parsed.sources into citations. (+12 more)
...
Cohesion: 0.07
Nodes (28): get_prompt(), load_builtin_prompts(), Import the built-in prompt modules so they self-register., register(), get_prompt(), load_builtin_prompts(), Import the built-in prompt modules so they self-register.      Safe to call mult, register() (+20 more)
...
Cohesion: 0.09
Nodes (47): CollectRequest, compute_iso_week_date_range(), EntityType, normalize_text(), NormalizedAlbum, NormalizedArtist, NormalizedLabel, NormalizedStyle (+39 more)
...
Cohesion: 0.03
Nodes (109): BucketBadge(), BucketBadgeProps, BucketCard(), BucketCardMode, BucketCardProps, BucketDistributeButtons(), BucketDistributeButtonsProps, BucketGrid() (+101 more)
...
Cohesion: 0.13
Nodes (16): PlaylistsRepository, Exposed for collaborators that need read access to other tables         from ins, Persist publish-state.          When ``mark_dirty`` is True we still record the, Record the YouTube Music playlist id + publish timestamp and clear         the y, test_list_all_filters_by_status_when_requested(), test_list_all_omits_status_clause_when_none(), test_validate_tracks_in_scope_empty_input(), FakeDataAPI (+8 more)
...
Cohesion: 0.50
Nodes (3): MatchFailedError, Worker-internal non-fatal: trigger review queue routing. Not an AppError., Exception
...
Cohesion: 0.04
Nodes (67): _build_artist_repository(), _build_auto_repository(), _build_data_api(), _build_sqs_client(), _dispatch_artists(), _queue_url(), Best-effort auto-enrichment dispatch for artists from curation actions.  Mirror, AutoEnrichRepository (+59 more)
...
Cohesion: 0.18
Nodes (5): list_vendors(), available_vendor_names(), Environment-driven configuration., Return the vendors for which an API key is configured., Settings

### Community 564 - "Community 564"
Cohesion: 0.05
Nodes (42): CommentsPanel(), Props, CopyPlaylistButton(), CopyPlaylistButtonProps, PlaylistPlayerPanelProps, PlaylistTrackRow(), PlaylistTracksList(), PlaylistTracksListProps (+34 more)
...
Cohesion: 0.09
Nodes (19): UserTokenMissingError, VendorAuthError, VendorQuotaError, VendorUnavailableError, Vendor error class tests (Plan 4 Task 2)., test_match_failed_error_non_http(), test_user_token_missing_error(), test_vendor_auth_error_code() (+11 more)
...
- **Why does `log_event()` connect `Curation API Handler` to `Playlists UI`, `API Route Handlers (admin/enrich)`, `KMS Envelope & Auth Crypto`, `Community 262`, `Community 395`, `Admin Artist API Types`, `Enrichment Data Models`, `Community 269`, `Admin Label API Types`, `Community 151`, `Provider Protocols`, `Enrichment Orchestrator`, `Community 163`, `Community 37`, `Community 293`, `Community 554`, `Community 44`, `Community 181`, `Community 55`, `Community 441`, `Community 189`, `Community 67`, `Community 72`, `Community 73`, `Community 76`, `Community 217`, `Community 363`, `Community 235`, `Community 250`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `lambda_handler()` connect `Community 269` to `Curation API Handler`, `API Route Handlers (admin/enrich)`, `Community 66`, `Community 169`, `Community 75`, `Community 175`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `api()` connect `Community 238` to `Auto-Enrich Config (FE API)`, `Community 133`, `Triage Finalize UI`, `Bucket Player UI`, `Playlist/Bucket Track Rows`, `Spotify Backend Client`, `Frontend API Errors & Types`, `Vendor Stubs (Apple/Deezer)`, `Community 152`, `Admin Backlog UI`, `Home Dashboard UI`, `Auto-Enrich Repository`, `Community 160`, `Community 33`, `Community 164`, `Community 36`, `Community 38`, `Community 167`, `Community 298`, `Community 46`, `Community 430`, `Community 564`, `Community 319`, `Community 65`, `Community 202`, `Community 80`, `Community 234`?**
...
- **Should `Curation API Handler` be split into smaller, more focused modules?**
  _Cohesion score 0.07965043695380775 - nodes in this community are weakly interconnected._
- **Should `API Route Handlers (admin/enrich)` be split into smaller, more focused modules?**
  _Cohesion score 0.06266866566716642 - nodes in this community are weakly interconnected._