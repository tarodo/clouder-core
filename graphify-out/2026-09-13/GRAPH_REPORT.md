# Graph Report - clouder-core  (2026-09-13)

## Corpus Check
- 2022 files · ~1,810,128 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10616 nodes · 21014 edges · 563 communities (519 shown, 44 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 1012 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a7a3cd61`
...
## Communities (563 total, 44 thin omitted)

### Community 0 - "Playlists UI"
Cohesion: 0.05
Nodes (52): ConfirmOverwriteRequiredError, CoverMissingError, CoverTooLargeError, CurationError, InactiveBucketError, InactiveStagingFinalizeError, InvalidSpotifyRefError, InvalidStateError (+44 more)

### Community 1 - "Curation API Handler"
Cohesion: 0.08
Nodes (88): _safe(), try_dispatch_artists_for_track(), _build_s3_storage(), _build_spotify_user_client(), _build_storage_if_needed(), _category_response(), _comments_factory(), _create_triage_block() (+80 more)

### Community 2 - "API Route Handlers (admin/enrich)"
Cohesion: 0.08
Nodes (91): Any, ApiSettings, _extract_user_id(), handle_put_auto_config(), _build_repository(), _build_sqs_client(), _extract_user_id(), handle_get_artist() (+83 more)

### Community 3 - "Admin Coverage/Enrich UI"
Cohesion: 0.02
Nodes (122): ApiError, ActiveBlocksList(), ActiveBlocksListProps, CountersGrid(), CountersGridProps, CurateSetupPage(), CurateSetupPageProps, CurateSkeleton() (+114 more)
...
Cohesion: 0.04
Nodes (36): ClouderRepository, Record a terminal 'no match found' outcome so the read surface can         retur, Stamp `spotify_searched_at` on the next *limit* candidates and return         th, Hand back rows claimed at *claimed_at* that never got a result.          Rows th, Read-only peek used to decide whether a follow-up batch is needed.          Must, Clear spotify_searched_at for not-found tracks in the publish-date         range, Copy release_type from tracks onto their parent albums.          Runs a single U, UpdateSpotifyResultCmd (+28 more)

### Community 6 - "Library Artist/Label UI"
Cohesion: 0.13
Nodes (19): AnalyticsError, build_queries(), _cached_rows(), _client(), _correlation_id(), create_default_athena_client(), lambda_handler(), Standalone analytics-api Lambda (§10 serving).  Serves per-user analytics by run (+11 more)
...
Cohesion: 0.04
Nodes (35): ArtistEnrichmentMessage, EnrichArtistInput, EnrichArtistsRequestIn, SQS message schema for artist enrichment (HTTP request models added in 1B)., Body of one SQS message — one per artist, one Lambda invocation.      The disamb, POST /admin/artists/enrich body., BaseModel, AddTrackIn (+27 more)
...
Cohesion: 0.09
Nodes (10): DataAPIClient, Exposed for collaborators that need read access to other tables         from ins, DataAPIClient, FakeRdsDataClient, test_batch_execute_sends_parameter_sets(), test_batch_execute_skips_empty_parameter_sets(), test_execute_sends_params_and_returns_rows(), test_execute_with_transaction_id() (+2 more)

### Community 14 - "Enrichment Data Models"
Cohesion: 0.09
Nodes (31): CategoriesList(), CategoriesListProps, CategoryRow(), CategoryRowProps, StyleSelector(), StyleSelectorProps, categoriesByStyleKey(), Category (+23 more)

### Community 15 - "Categories/Triage Repository"
Cohesion: 0.02
Nodes (129): api(), ApiInit, notifyAuthFailure(), RefreshResponse, tryRefreshOnce(), AddToPlaylistSubmenu(), AddToPlaylistSubmenuProps, CommentsPanel() (+121 more)
...
Cohesion: 0.02
Nodes (78): tokenStore, BLOCK, TRACK, BucketDetailPage(), BLOCK, TRACK, CategoryDetailPage(), TriageDetailPage() (+70 more)

### Community 18 - "Vendor Stubs (Apple/Deezer)"
Cohesion: 0.11
Nodes (9): IdentityMapEntry, UpsertSourceEntityCmd, FakeRepo, Two artists with the same name but different beatport_ids must create     two se, _raw_track(), test_canonicalizer_auto_creates_entities_when_no_matches(), test_canonicalizer_reuses_existing_identity_and_updates_track(), test_canonicalizer_threads_key_into_create_track_cmd() (+1 more)
...
Cohesion: 0.10
Nodes (21): _build_narrative_prompt(), _filter_parseable(), _highest_confidence_cell(), merge_cells(), _merge_deterministic(), _merge_narrative(), _rank_list_round_robin(), Multi-vendor consensus aggregator for LabelInfo cells.  The single public entry (+13 more)
...
Cohesion: 0.12
Nodes (14): RunDetail, BacklogLabel, RunCell, RunDetail, ArtistRunDetailHeader(), BacklogTable(), Props, RunDetailCellsTable() (+6 more)
...
Cohesion: 0.14
Nodes (18): LabelsListResponse, EntityTabs(), Props, LibraryFilters(), Props, StyleOption, artistsListKey(), ArtistsListMy (+10 more)
...
Cohesion: 0.09
Nodes (23): ArtistHistoryCell, ArtistHistoryResponse, ArtistsListResponse, BacklogArtist, BacklogResponse, EnrichBody, EnrichmentOptions, RunCell (+15 more)
...
Cohesion: 0.05
Nodes (51): AppleExporter, Apple export stub — raises VendorDisabledError until implemented., AppleLookup, Apple lookup stub — raises VendorDisabledError until implemented., Application-level errors for the collector Lambda., Raised when a registry lookup cannot be served. The .reason attribute     discri, VendorDisabledError, DeezerExporter (+43 more)
...
Cohesion: 0.09
Nodes (45): CollectRequest, compute_iso_week_date_range(), EntityType, normalize_text(), NormalizedAlbum, NormalizedArtist, NormalizedLabel, NormalizedStyle (+37 more)

### Community 38 - "Community 38"
Cohesion: 0.12
Nodes (12): UserTokenMissingError, VendorAuthError, VendorQuotaError, VendorUnavailableError, Vendor error class tests (Plan 4 Task 2)., test_match_failed_error_non_http(), test_user_token_missing_error(), test_vendor_auth_error_code() (+4 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (64): _build_artist_repository(), _build_auto_repository(), _build_data_api(), _build_sqs_client(), _dispatch_artists(), _queue_url(), Best-effort auto-enrichment dispatch for artists from curation actions.  Mirror, AutoEnrichConfigIn (+56 more)
...
Cohesion: 0.07
Nodes (25): AddTracksModal(), AddTracksModalProps, mutateAsync, BUCKETS, setup(), useCurateHotkeys(), CurateIndexRedirect(), CurateSessionPage() (+17 more)

### Community 42 - "Community 42"
Cohesion: 0.04
Nodes (47): CategoryDetailHeader(), CategoryDetailHeaderProps, CategoryPlayerPanelProps, SortableTh(), SortableThProps, { removeAsync }, TRACK, TrackRowActions() (+39 more)
...
Cohesion: 0.04
Nodes (58): BucketBadge(), BucketBadgeProps, BucketCard(), BucketCardMode, BucketCardProps, BucketDistributeButtons(), BucketDistributeButtonsProps, BucketGrid() (+50 more)
...
Cohesion: 0.05
Nodes (45): BucketPlayerPanelProps, BucketTrackRow(), BucketTrackRowProps, track, BucketTracksList(), BucketTracksListProps, CurateCard(), CurateCardProps (+37 more)
...
Cohesion: 0.07
Nodes (29): AuthRepository, _b64d(), _b64d_optional(), _b64e(), Aurora Data API repository for users / sessions / vendor tokens.  Bytea columns, SessionRow, _to_session_row(), _to_user_row() (+21 more)

### Community 53 - "Community 53"
Cohesion: 0.09
Nodes (20): EnvelopePayload, SpotifyProfile, SpotifyTokenSet, _ctx(), FakeKms, FakeOAuth, FakeRepo, End-to-end auth flow with in-memory fakes for KMS, OAuth, repo. (+12 more)
...
Cohesion: 0.10
Nodes (20): StorageError, S3Storage, FakeS3Client, _meta(), Tests for S3Storage: write_run_artifacts and read_releases., FakeS3Client, _meta(), Spotify raw results must not overwrite each other across follow-up batches.  `_e (+12 more)
...
Cohesion: 0.07
Nodes (19): _enqueue_spotify_search_after_canonicalization(), lambda_handler(), Enqueue Spotify ISRC search after canonicalization completes., FakeRepo, FakeS3Client, _FakeTransaction, Tests for SQS worker lambda: message parsing, error classification, happy path., Minimal repo mock supporting both worker lifecycle AND canonicalization. (+11 more)
...
Cohesion: 0.07
Nodes (18): _enable_all_stubs(), Contract tests — every stub vendor satisfies LookupProvider/ExportProvider Proto, MonkeyPatch, Unit tests for provider registry and VENDORS_ENABLED gating., Disabled vendor must not instantiate its provider — important so     that unrela, Regression guard: every enricher built from `_BUILDERS` must expose     a unique, test_disabled_vendor_does_not_build_bundle(), test_enabled_vendors_empty() (+10 more)

### Community 63 - "Community 63"
Cohesion: 0.12
Nodes (33): _ctx(), _event(), Integration tests for GET /admin/coverage., reset_caches(), test_coverage_db_not_configured_503(), test_coverage_merges_spotify_weeks(), test_coverage_missing_week_year_400(), test_coverage_requires_admin() (+25 more)
...
Cohesion: 0.18
Nodes (13): _build_narrative_prompt(), _filter_parseable(), _highest_confidence_cell(), _merge_deterministic(), _merge_narrative(), _rank_list_round_robin(), Multi-vendor consensus aggregator for LabelInfo cells.  The single public entry, Assemble the user message from all parseable cells' narrative fields. (+5 more)
...
Cohesion: 0.13
Nodes (24): AccessClaims, _decode(), InvalidTokenError, issue_access_token(), issue_refresh_token(), HS256 JWT issue / verify helpers for spec-A access and refresh tokens., RefreshClaims, verify_access_token() (+16 more)
...
Cohesion: 0.09
Nodes (29): merge_cells(), Merge vendor cells into a single LabelInfo with DeepSeek narrative synthesis., aggregate(), build_deepseek_client(), build_vendors(), list_fixtures(), list_vendors(), _parse_csv() (+21 more)
...
Cohesion: 0.24
Nodes (6): User-OAuth Spotify Web API client (playlist publish, import).  Distinct from col, SpotifyArtistRef, SpotifyPlaylistRef, SpotifyTrackPayload, SpotifyUserClient, _track_payload()
...
Cohesion: 0.10
Nodes (29): merge_cells(), Merge vendor cells into a single ArtistInfo with DeepSeek narrative synthesis., aggregate(), build_deepseek_client(), build_vendors(), list_fixtures(), list_vendors(), _parse_csv() (+21 more)
...
Cohesion: 0.22
Nodes (5): PageHeader(), PageHeaderProps, useArtistEnrichmentRuns(), AdminArtistEnrichmentRunsPage(), mockPages
...
Cohesion: 0.05
Nodes (44): SpotifyAuthError, SpotifyUnavailableError, _album_release_sort_key(), Spotify Web API client with Client Credentials auth and retry semantics., Map each Spotify track id to its ordered artist names (batched)., Spotify text search fallback when ISRC lookup returned no items.          Builds, Try ISRCs that differ from the query by ±1, ±2 in the last digit.          Sibli, Search Spotify for a single track by ISRC.          Fetches up to 10 results and (+36 more)
...
Cohesion: 0.08
Nodes (31): normalize_playlist_name(), parse_spotify_playlist_ref(), parse_spotify_ref(), Pure helpers for playlists (spec 2026-05-11): validation, normalization, Spotify, Same contract as categories_service.validate_reorder_set., Lowercase + trim + collapse internal whitespace., Return the 22-char Spotify track ID or raise InvalidSpotifyRefError.      Accept, Return the 22-char Spotify playlist ID or raise InvalidSpotifyRefError.      Acc (+23 more)
...
Cohesion: 0.09
Nodes (26): reset_settings_cache(), lambda_handler(), _fake_search_results(), FakeRepo, FakeRepoWithRemaining, FakeS3Client, Tests for Spotify search SQS worker lambda., Build fake search function returning given (isrc, track_id, spotify_id) tuples. (+18 more)
...
Cohesion: 0.11
Nodes (28): Thin wrapper over AWS RDS Data API., Repositories backed by Aurora Data API., UpsertVendorMatchCmd, VendorTrackMatch, Aurora Data API repository for playlists (spec 2026-05-11).  Tenancy: every meth, Decimal, _make_repo(), Repository tests for vendor_match_map + match_review_queue (Plan 4 Task 5). (+20 more)
...
Cohesion: 0.10
Nodes (24): Retry wrapper for RDS Data API transient errors.  Aurora Serverless v2 with min_, Retry decorator for RDS Data API client methods.      Retries only on transient, Retry decorator for RDS Data API calls where the operation must     not be re-ex, _retry(), retry_data_api(), retry_data_api_pre_execution(), F, Tests for Data API retry wrapper. (+16 more)
...
Cohesion: 0.05
Nodes (34): ADR-0001: RDS Data API at Lambda runtime (vs psycopg), Consequences, Context, Decision, ADR-0003: Saturday-week as canonical period, Consequences, Context, Decision (+26 more)
...
Cohesion: 0.14
Nodes (25): Per (beatport style, Saturday week of publish_date) Spotify-match         counts, first_saturday(), _last_saturday_on_or_before(), Saturday-anchored week math.  Convention used by the admin Beatport ingest UI., saturday_week_range(), week_of_date(), weeks_in_year(), date (+17 more)
...
Cohesion: 0.02
Nodes (82): Action, AuthContext, AuthContextValue, AuthProvider(), AuthState, CallbackResponse, getAuthSnapshot(), Me (+74 more)
...
Cohesion: 0.21
Nodes (11): EnrichResult, SpotifyEnricher — wraps SpotifyLookup to expose release_type as EnrichResult.  C, SpotifyEnricher, test_enrich_result_required_fields(), _FakeLookup, Unit tests for SpotifyEnricher (release_type extraction)., test_enricher_implements_protocol(), test_enricher_rejects_wrong_entity_type() (+3 more)
...
Cohesion: 0.12
Nodes (29): build_adapters_from_run_config(), _cell_payload(), enrich_label_for_run(), High-level wiring: run vendors in parallel, aggregate, persist., Rebuild a VendorResponse from a cell payload — used to keep repository's API sta, Instantiate exactly the requested adapters with their per-run models., Shape mirrors experiments/labels output so aggregator.merge_cells works unchange, Dispatch all adapters concurrently. One call per adapter, one cell per result. (+21 more)

### Community 219 - "Community 219"
Cohesion: 0.11
Nodes (23): KmsEnvelope, KMS envelope encryption with AES-GCM and a 5-min in-memory data-key cache., Wraps KMS GenerateDataKey/Decrypt with AES-GCM and a small TTL cache., _b64d(), _b64e(), _OAuthClientLike, _parse_expires_at(), Read + KMS-decrypt + refresh the user's Spotify OAuth access token.  Storage sha (+15 more)
...
Cohesion: 0.17
Nodes (15): BacklogResponse, BacklogToolbar(), Props, StyleFilterOption, artistBacklogKey(), ArtistStatusFilter, useArtistBacklog(), UseArtistBacklogParams (+7 more)
...
Cohesion: 0.04
Nodes (60): ArtistDetail, LabelDetail, LabelSummary, ArtistChannelLinks(), ArtistDetailHeader(), Props, ArtistOverviewTab(), ArtistPreferenceButtons() (+52 more)
...
Cohesion: 0.06
Nodes (22): _extract_json(), KimiAdapter, _lat(), Kimi (Moonshot AI) adapter via the OpenAI-compatible SDK with $web_search builti, Strip markdown fences and return the first balanced JSON object substring., _schema_hint(), _zero_usage(), PerplexitySonarAdapter (+14 more)
...
Cohesion: 0.09
Nodes (24): AISignalKind, ArtistType, Load and validate fixtures.yaml., AIContentStatus, AISignal, AISignalKind, ArtistInfo, ArtistType (+16 more)

### Community 251 - "Community 251"
Cohesion: 0.07
Nodes (25): ADR-0016: Label enrichment subsystem (multi-vendor consensus, async), Consequences, Context, Decision, ADR-0017: Artist enrichment mirrors label enrichment (parallel package, not shared engine), Consequences, Context, Decision (+17 more)
...
Cohesion: 0.21
Nodes (15): _beatport_track_row(), _make_data_api(), _make_repo(), test_create_inserts_row_and_returns_playlist(), test_create_raises_limit_reached_at_200(), test_create_translates_unique_violation_to_name_conflict(), test_get_filters_soft_deleted(), test_get_returns_none_for_unknown_id() (+7 more)
...
Cohesion: 0.33
Nodes (9): Tests for the atomic Spotify-search claim repository method.  Two spotify-search, The follow-up check must stay read-only or it would strand a track., _repo(), test_claim_selects_only_unsearched_tracks_with_isrc(), test_claim_skips_rows_locked_by_a_concurrent_worker(), test_claim_sql_is_a_single_atomic_statement(), test_claim_stamps_searched_at_and_returns_projection(), test_claim_still_projects_artists_for_metadata_fallback() (+1 more)

### Community 279 - "Community 279"
Cohesion: 0.47
Nodes (8): _correlation_for(), _ctx(), _event_without_correlation_header(), _log_lines(), One request must carry one correlation_id across every log line.  `_extract_corr, test_failed_ingest_logs_one_correlation_id(), test_failed_ingest_response_matches_logged_correlation_id(), test_supplied_correlation_header_is_preserved()
...
Cohesion: 0.06
Nodes (36): 10.1 Edge cases worth code comments, 10.2 Future flags, 10.3 Cross-spec dependencies, 10. Open Items, Edge Cases, Future Flags, 11. Acceptance Criteria, 12. References, 1. Context and Goal, 2. Scope (+28 more)
...
Cohesion: 0.02
Nodes (106): call(), CallOptions, ensureOk(), PlayArgs, SeekArgs, spotifyApi, TransferArgs, spotifyTokenStore (+98 more)
...
Cohesion: 0.06
Nodes (29): ArtistInfoRequest, Vendor-facing schema: ArtistInfo minus AI-detection fields.      Structured outp, get_prompt(), load_builtin_prompts(), Import the built-in prompt modules so they self-register., register(), get_prompt(), load_builtin_prompts() (+21 more)
...
Cohesion: 0.08
Nodes (26): _build_alembic_database_url(), lambda_handler(), Lambda handler that executes Alembic migrations against Aurora., _rds_client(), _read_secret(), utc_now(), CanonicalizationMessage, MigrationCommand (+18 more)
...
Cohesion: 0.12
Nodes (15): Metadata fallback, Perplexity label and artist screening (superseded), Result schema, Search and enrichment, Sibling ISRC neighbour matching, Spotify ISRC lookup, Vendor match cache, Analytics first run (bootstrap) — superseded (+7 more)
...
Cohesion: 0.13
Nodes (15): LabelHistoryCell, LabelHistoryResponse, RunsListResponse, RunSummary, groupByRun(), LabelHistoryDrawer(), Props, RunGroup (+7 more)
...
- **Why does `log_event()` connect `Curation API Handler` to `Playlists UI`, `API Route Handlers (admin/enrich)`, `Library Artist/Label UI`, `Triage Finalize UI`, `Community 269`, `Storage & Ingest Schemas`, `Community 151`, `Admin Backlog UI`, `Home Dashboard UI`, `Provider Protocols`, `Enrichment Orchestrator`, `Community 163`, `Community 39`, `Community 43`, `Community 304`, `Community 305`, `Community 181`, `Community 55`, `Community 439`, `Community 58`, `Community 189`, `Community 319`, `Community 65`, `Community 69`, `Community 72`, `Community 73`, `Community 217`, `Community 218`, `Community 91`, `Community 219`, `Community 235`, `Community 374`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `api()` connect `Categories/Triage Repository` to `Admin Coverage/Enrich UI`, `Enrichment Data Models`, `Frontend API Errors & Types`, `Community 275`, `Auth Handler & Settings`, `Playlists Repository`, `Community 152`, `Auto-Enrich Repository`, `Community 543`, `Community 164`, `Community 41`, `Community 42`, `Community 560`, `Community 49`, `Community 60`, `Community 317`, `Community 197`, `Community 198`, `Community 70`, `Community 78`, `Community 227`, `Community 234`, `Community 378`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `DataAPIClient` connect `Admin Artist API Types` to `API Route Handlers (admin/enrich)`, `KMS Envelope & Auth Crypto`, `Triage Finalize UI`, `Community 144`, `Frontend Auth Provider`, `Vendor Stubs (Apple/Deezer)`, `Backend Error Hierarchy`, `Admin Label API Types`, `Label Auto-Dispatch Worker`, `Community 406`, `Provider Protocols`, `Enrichment Orchestrator`, `Community 160`, `Community 165`, `Community 39`, `Community 168`, `Community 428`, `Community 47`, `Community 48`, `Community 304`, `Community 52`, `Community 54`, `Community 61`, `Community 69`, `Community 72`, `Community 91`, `Community 219`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **What connects `AWS Lambda handler for Beatport weekly releases collection API.`, `Inputs for `_run_beatport_ingest`.      Three valid field combinations:     - Le`, `One request must carry one correlation_id across every log line.  `_extract_corr` to the rest of the system?**
...
- **Should `Curation API Handler` be split into smaller, more focused modules?**
  _Cohesion score 0.08094994892747702 - nodes in this community are weakly interconnected._
- **Should `API Route Handlers (admin/enrich)` be split into smaller, more focused modules?**
  _Cohesion score 0.07637281716810436 - nodes in this community are weakly interconnected._