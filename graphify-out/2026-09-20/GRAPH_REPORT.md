# Graph Report - clouder-core  (2026-09-20)

## Corpus Check
- 2023 files · ~1,811,601 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10622 nodes · 21034 edges · 611 communities (564 shown, 47 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 1016 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `24b78277`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_Playlists UI|Playlists UI]]
- [[_COMMUNITY_Curation API Handler|Curation API Handler]]
- [[_COMMUNITY_API Route Handlers (adminenrich)|API Route Handlers (admin/enrich)]]
- [[_COMMUNITY_Admin CoverageEnrich UI|Admin Coverage/Enrich UI]]
- [[_COMMUNITY_Auto-Enrich Config (FE API)|Auto-Enrich Config (FE API)]]
- [[_COMMUNITY_KMS Envelope & Auth Crypto|KMS Envelope & Auth Crypto]]
- [[_COMMUNITY_Library ArtistLabel UI|Library Artist/Label UI]]
- [[_COMMUNITY_Artist Enrichment Repository|Artist Enrichment Repository]]
- [[_COMMUNITY_Triage Finalize UI|Triage Finalize UI]]
- [[_COMMUNITY_Bucket Player UI|Bucket Player UI]]
- [[_COMMUNITY_Curation Error Types|Curation Error Types]]
- [[_COMMUNITY_PlaylistBucket Track Rows|Playlist/Bucket Track Rows]]
- [[_COMMUNITY_Spotify Backend Client|Spotify Backend Client]]
- [[_COMMUNITY_Admin Artist API Types|Admin Artist API Types]]
- [[_COMMUNITY_Enrichment Data Models|Enrichment Data Models]]
- [[_COMMUNITY_CategoriesTriage Repository|Categories/Triage Repository]]
- [[_COMMUNITY_Frontend Auth Provider|Frontend Auth Provider]]
- [[_COMMUNITY_Frontend API Errors & Types|Frontend API Errors & Types]]
- [[_COMMUNITY_Vendor Stubs (AppleDeezer)|Vendor Stubs (Apple/Deezer)]]
- [[_COMMUNITY_Backend Error Hierarchy|Backend Error Hierarchy]]
- [[_COMMUNITY_Admin Label API Types|Admin Label API Types]]
- [[_COMMUNITY_Label Auto-Dispatch Worker|Label Auto-Dispatch Worker]]
- [[_COMMUNITY_Auth Handler & Settings|Auth Handler & Settings]]
- [[_COMMUNITY_Storage & Ingest Schemas|Storage & Ingest Schemas]]
- [[_COMMUNITY_Playlists Repository|Playlists Repository]]
- [[_COMMUNITY_Artist Auto-Dispatch Worker|Artist Auto-Dispatch Worker]]
- [[_COMMUNITY_Admin Backlog UI|Admin Backlog UI]]
- [[_COMMUNITY_Enrichment Aggregator|Enrichment Aggregator]]
- [[_COMMUNITY_Home Dashboard UI|Home Dashboard UI]]
- [[_COMMUNITY_Provider Protocols|Provider Protocols]]
...
2. `log_event()` - 126 edges
3. `server` - 96 edges
4. `api()` - 95 edges
5. `DataAPIClient` - 88 edges
6. `tokenStore` - 86 edges
7. `PlaylistsRepository` - 81 edges
8. `ClouderRepository` - 75 edges
9. `ValidationError` - 69 edges
...
## Communities (611 total, 47 thin omitted)

### Community 0 - "Playlists UI"
Cohesion: 0.05
Nodes (50): Aurora Data API repository for spec-C categories.  Tenancy: every method takes `, Pure helpers for spec-C categories: normalization, validation, reorder checks., Ensure the requested id list equals the actual alive set, no dups.      Used by, validate_reorder_set(), ConfirmOverwriteRequiredError, CoverMissingError, CoverTooLargeError, CurationError (+42 more)

### Community 1 - "Curation API Handler"
Cohesion: 0.07
Nodes (94): _safe(), try_dispatch_artists_for_track(), _build_s3_storage(), _build_spotify_user_client(), _build_storage_if_needed(), _categories_factory(), _category_response(), _comments_factory() (+86 more)

### Community 2 - "API Route Handlers (admin/enrich)"
Cohesion: 0.07
Nodes (95): Any, _build_repository(), _build_sqs_client(), _extract_user_id(), handle_get_artist(), handle_get_artist_history(), handle_get_artist_user(), handle_get_artists_list() (+87 more)
...
Cohesion: 0.06
Nodes (30): FinalizeBlockerRow(), FinalizeBlockerRowProps, BlockerVariantProps, ConfirmVariantProps, ErrorCtx, FinalizeModal(), Phase, STATUSES (+22 more)

### Community 5 - "KMS Envelope & Auth Crypto"
Cohesion: 0.06
Nodes (44): Retry wrapper for RDS Data API transient errors.  Aurora Serverless v2 with min_, Structured logging helpers with sensitive data redaction., redact_sensitive_data(), _sanitize_event(), _sanitize_fields(), _build_alembic_database_url(), lambda_handler(), Lambda handler that executes Alembic migrations against Aurora. (+36 more)

### Community 6 - "Library Artist/Label UI"
Cohesion: 0.19
Nodes (14): CurateSkeleton(), clearLastCurateLocation(), CurateLocation, isStaleLocation(), readLastCurateLocation(), readLastCurateStyle(), readStorage(), Storage (+6 more)
...
Cohesion: 0.06
Nodes (37): useBucketPlayerQueue(), useCategoryPlayerQueue(), useDeletePlaylist(), usePatchPlaylist(), usePlaylistDetail(), usePlaylistPlayerQueue(), usePlaylistTracks(), useRemoveTrackFromPlaylist() (+29 more)

### Community 9 - "Bucket Player UI"
Cohesion: 0.05
Nodes (47): ArtistDetail, ArtistHistoryCell, ArtistHistoryResponse, ArtistSummary, BacklogArtist, EnrichBody, EnrichmentOptions, ArtistChannelLinks() (+39 more)

### Community 10 - "Curation Error Types"
Cohesion: 0.16
Nodes (19): Path, main(), splitlab CLI: pull-sample | run | report., load_settings(), _parse_env(), Settings: .env loader (no python-dotenv dep) + fixed experiment constants., Settings, _filled() (+11 more)

### Community 11 - "Playlist/Bucket Track Rows"
Cohesion: 0.06
Nodes (21): TrackRowActions(), AddTrackTagInput, MutationContext, AddTrackToCategoryInput, useAddTrackToCategory(), categoryTracksKey(), PaginatedTracks, MovePartialError (+13 more)

### Community 12 - "Spotify Backend Client"
Cohesion: 0.05
Nodes (46): BacklogResponse, BacklogLabel, BacklogResponse, EnrichBody, EnrichmentOptions, LabelHistoryCell, LabelHistoryResponse, RunsListResponse (+38 more)

### Community 13 - "Admin Artist API Types"
Cohesion: 0.07
Nodes (22): Canonicalizer, _chunks(), _identity_cmd(), _payload_hash(), Canonicalization workflow for Beatport entities., _source_entity_cmd(), CanonicalizationResult, NormalizedBundle (+14 more)

### Community 14 - "Enrichment Data Models"
Cohesion: 0.13
Nodes (10): _build_repository(), Best-effort fan-out of comment-collection jobs for a finalized triage block.  Ru, _build_repository(), Best-effort dispatch of comment-collection jobs from curation/match paths.  Call, _utc_now(), CommentCollectMessage, SQS message contract for the comment-collection worker., create_default_comments_repository() (+2 more)
...
Cohesion: 0.03
Nodes (38): tokenStore, CategoryDetailPage(), handlers, PLAYLIST_DEFAULTS, server, testTheme, seedPlaylists, mockPages (+30 more)

### Community 18 - "Vendor Stubs (Apple/Deezer)"
Cohesion: 0.06
Nodes (38): call(), CallOptions, ensureOk(), PlayArgs, SeekArgs, spotifyApi, TransferArgs, AuthProvider() (+30 more)

### Community 19 - "Backend Error Hierarchy"
Cohesion: 0.04
Nodes (63): _build_narrative_prompt(), _filter_parseable(), _highest_confidence_cell(), merge_cells(), _merge_deterministic(), _merge_narrative(), _rank_list_round_robin(), Multi-vendor consensus aggregator for ArtistInfo cells.  The single public entry (+55 more)
...
Cohesion: 0.16
Nodes (11): SpotifyAuthError, SpotifyUnavailableError, Map each Spotify track id to its ordered artist names (batched)., Spotify text search fallback when ISRC lookup returned no items.          Builds, Try ISRCs that differ from the query by ±1, ±2 in the last digit.          Sibli, Search Spotify for a single track by ISRC.          Fetches up to 10 results and, Authenticate or reuse cached token., Obtain access token via Client Credentials flow. (+3 more)

### Community 23 - "Storage & Ingest Schemas"
Cohesion: 0.05
Nodes (34): AISignal, BaseModel, AddTrackIn, AddTracksIn, CoverUploadUrlIn, CreateCategoryIn, CreatePlaylistIn, CreateTriageBlockIn (+26 more)

### Community 24 - "Playlists Repository"
Cohesion: 0.05
Nodes (12): BucketTracksList(), CategoryDetailHeader(), CategoryDetailHeaderProps, ForceToggle(), ForceToggleProps, MOCK_ARTIST, auth, signIn (+4 more)
...
Cohesion: 0.05
Nodes (25): mutateAsync, { removeAsync }, TRACK, BLOCK, TRACK, BucketDetailPage(), BLOCK, TRACK (+17 more)

### Community 29 - "Provider Protocols"
Cohesion: 0.19
Nodes (13): MatchInput, main(), Enqueue YT Music match jobs for tracks already in playlists.  Usage:     PYTHONP, FakeSqs, _inp(), test_enqueue_no_queue_url_is_noop(), test_enqueue_sends_one_message_per_input(), test_enqueue_skips_invalid_input() (+5 more)

### Community 30 - "Auto-Enrich Repository"
Cohesion: 0.06
Nodes (35): CopyPlaylistButton(), CopyPlaylistButtonProps, PlaylistPlayerPanelProps, PlaylistTrackRow(), PlaylistTrackRowProps, PlaylistTrackRowView(), ViewProps, PlaylistTracksList() (+27 more)

### Community 31 - "Enrichment Orchestrator"
Cohesion: 0.04
Nodes (84): UpsertVendorTokenCmd, AuthSettings, get_auth_settings(), _parse_csv(), Auth Lambda settings + secret resolution., resolve_jwt_signing_key(), resolve_oauth_client_credentials(), resolve_ytmusic_oauth_credentials() (+76 more)
...
Cohesion: 0.07
Nodes (31): CoverPicker(), CoverPickerProps, DriftBadge(), DriftTarget, editDescriptionSchema, FormValues, PlaylistFormDialog(), PlaylistFormDialogProps (+23 more)
...
Cohesion: 0.07
Nodes (42): AppleExporter, Apple export stub — raises VendorDisabledError until implemented., AppleLookup, Apple lookup stub — raises VendorDisabledError until implemented., Raised when a registry lookup cannot be served. The .reason attribute     discri, VendorDisabledError, DeezerExporter, Deezer export stub — raises VendorDisabledError until implemented. (+34 more)

### Community 36 - "Community 36"
Cohesion: 0.08
Nodes (26): PublishButton(), PublishButtonProps, mutateAsync, playlist, RESULT, PublishConfirmModal(), PublishConfirmModalProps, PublishResultModal() (+18 more)

### Community 37 - "Community 37"
Cohesion: 0.14
Nodes (21): AIContentStatus, AISignalKind, ArtistType, Data models for artist enrichment., AIContentStatus, AISignalKind, ArtistType, EntityType (+13 more)
...
Cohesion: 0.12
Nodes (29): _database_url(), run_migrations_offline(), run_migrations_online(), Base, ClouderAlbum, ClouderArtist, ClouderLabel, ClouderStyle (+21 more)
...
Cohesion: 0.07
Nodes (35): ApiError, AddTracksModal(), AddTracksModalProps, CategoriesList(), CategoriesListProps, CategoryFormDialog(), CategoryFormDialogProps, CategoryFormMode (+27 more)
...
Cohesion: 0.17
Nodes (12): Google device-flow OAuth client for YouTube Music (ytmusicapi auth).  Uses the O, Generic / unrecoverable device-flow error., Google asked us to poll less frequently., User denied the consent screen., device_code expired — restart the flow., YtmusicAuthDenied, YtmusicAuthError, YtmusicAuthExpired (+4 more)

### Community 52 - "Community 52"
Cohesion: 0.08
Nodes (26): CategoryPlayerPanelProps, SortableTh(), SortableThProps, TrackRowProps, TrackRowActionsProps, TracksTab(), TracksTabProps, CategoryTagRef (+18 more)
...
Cohesion: 0.07
Nodes (30): StorageError, utc_now(), CanonicalizationMessage, get_worker_settings(), create_default_s3_client(), S3 persistence for weekly snapshots., S3Storage, _enqueue_spotify_search_after_canonicalization() (+22 more)
...
Cohesion: 0.07
Nodes (28): CurateSession(), CurateSessionProps, DestinationGrid(), DestinationGridProps, DIGIT_CODES, BUCKETS, setup(), useCurateHotkeys() (+20 more)
...
Cohesion: 0.06
Nodes (36): BucketBadge(), BucketBadgeProps, BucketCard(), BucketCardMode, BucketCardProps, BucketDistributeButtons(), BucketDistributeButtonsProps, BucketGrid() (+28 more)
...
Cohesion: 0.08
Nodes (11): Load and validate fixtures.yaml., AISignal, Fixture, FixturesFile, GroundTruth, Data models for the artist sandbox., make_fixture(), StubVendor (+3 more)
...
Cohesion: 0.26
Nodes (14): AnalyticsError, build_queries(), _cached_rows(), _client(), _correlation_id(), create_default_athena_client(), lambda_handler(), Standalone analytics-api Lambda (§10 serving).  Serves per-user analytics by run (+6 more)
...
Cohesion: 0.10
Nodes (9): DataAPIClient, Exposed for collaborators that need read access to other tables         from ins, FakeRdsDataClient, test_batch_execute_sends_parameter_sets(), test_batch_execute_skips_empty_parameter_sets(), test_execute_sends_params_and_returns_rows(), test_execute_with_transaction_id(), test_transaction_commits_on_success() (+1 more)
...
Cohesion: 0.13
Nodes (17): CategoriesRepository, CategoryRow, Insert (track, source_triage_block_id) pairs idempotently.          Used by both, Add one track to a category. Idempotent on (category_id, track_id).          Ret, TrackInCategoryRow, NotFoundError, _category_exists(), _FakeDataAPI (+9 more)
...
Cohesion: 0.11
Nodes (30): VendorMatchMessage, Spotify Web API client with Client Credentials auth and retry semantics., _process_one(), SQS-triggered worker that matches a canonical track to a vendor., _try_isrc(), _try_metadata(), LookupProvider, Batch ISRC search. Returns provider-specific result objects. (+22 more)
...
Cohesion: 0.18
Nodes (9): CoverageMatrix(), Props, COLORS, CoverageMatrixCell, Props, CoveragePayload, SpotifyWeekStats, formatSpotifyStats() (+1 more)

### Community 81 - "Community 81"
Cohesion: 0.08
Nodes (25): 10. Acceptance Criteria, 11. References, 1. Context and Goal, 2. Scope, 3. Architectural Decisions, 4.1 `categories`, 4.2 `category_tracks`, 4.3 Rationale notes (+17 more)
...
Cohesion: 0.16
Nodes (12): Narrative pass: OpenAI Responses API + web_search capped by max_tool_calls. Requ, run_narrative_pass(), _user_message(), Run the two-pass pipeline over the sample; one JSON cell per entity., ArtistFacts, ArtistNarrative, LabelNarrative, Request schemas for the two passes. Narrative = fuzzy/descriptive only; Facts = (+4 more)
...
Cohesion: 0.12
Nodes (15): _handle_delete_tag(), _handle_remove_track_tag(), _no_content(), _tags_factory(), TagNameConflictError, TagNotFoundError, TrackNotInAnyCategoryError, PlaylistTrackRow (+7 more)
...
Cohesion: 0.05
Nodes (38): Architecture, B1. Add `label_id` to triage `BucketTrack` payload, B2. `GET /labels` — user-facing list, B3. `GET /labels/{label_id}` — user-facing detail, B4. `GET /admin/labels/backlog` — admin, B5. `GET /admin/labels/enrich-runs` — admin, B6. Expand `GET /admin/labels/enrich-runs/{run_id}` with `cells[]`, B7. `GET /admin/labels/enrich/options` — admin (+30 more)
...
Cohesion: 0.53
Nodes (3): LongOperationOverlay(), LongOperationOverlayProps, useElapsedTime()

### Community 98 - "Community 98"
Cohesion: 0.12
Nodes (15): Approach, Backend, Frontend, Frontend — Spotify not-found page, `GET /tracks/spotify-not-found` filter extension, Goals, New route `POST /admin/spotify/retry-not-found`, Non-goals (+7 more)

### Community 99 - "Community 99"
Cohesion: 0.60
Nodes (4): contextDifferent(), contextOf(), hasPlayerCard(), RouteContext

### Community 100 - "Community 100"
Cohesion: 0.50
Nodes (3): Env, envSchema, parseEnv()
...
Cohesion: 0.05
Nodes (37): 10.1 Behavioural — reducer transitions, 10.2 Unit — `ForceToggle`, 10.3 Unit — `useAddTrackToCategory` / `useRemoveTrackFromCategory`, 10.4 Component — `DestinationGrid`, 10.5 Hook — `useCurateHotkeys`, 10.6 Integration — chain + undo, 10.7 i18n smoke, 10.8 Out of scope (+29 more)

### Community 127 - "Community 127"
Cohesion: 0.05
Nodes (37): 10.1 Route + serving gating, 10.2 Result cache, 10.3 Cold-start note, 10. Serving (Phase 1, in-app), 11. Dashboards (the value story), 12. Cost model (Phase 1, verified, portfolio volume), 13. Security & privacy, 14. Testing strategy (+29 more)
...
Cohesion: 0.11
Nodes (38): _beatport_track_row(), _make_data_api(), _make_repo(), Unit tests for PlaylistsRepository.  DataAPIClient is stubbed with a MagicMock t, list_tracks with tags_repo attaches artists, label, bpm, mix_name,     spotify_r, When tags_repo is omitted, tags field defaults to empty tuple., test_append_tracks_dedups_against_existing(), test_append_tracks_rejects_when_over_limit() (+30 more)
...
Cohesion: 0.06
Nodes (32): 10.1 Edge cases worth a code comment, 10.2 Carryover to F10 / F11, 10.3 Future flags, 10. Open Items, Edge Cases, Future Flags, 11. References, 1. Context and Goal, 2. Scope, 3. Architectural Decisions (+24 more)
...
Cohesion: 0.15
Nodes (5): PlaylistNotFoundError, AppendTracksResult, fake_repo(), FakePlaylistsRepo, In-memory PlaylistsRepository for integration tests.      Implements the subset

### Community 145 - "Community 145"
Cohesion: 0.06
Nodes (31): 10. Error Handling, 11. Testing Strategy, 12. Acceptance Criteria, 13. Open Mini-Questions for spec-A Implementation, 14. References, 1. Context and Goal, 2. Scope, 3. Architectural Decisions (+23 more)
...
Cohesion: 0.06
Nodes (30): 1. Data model, 2. API surface, 3.1 Navbar (`frontend/src/routes/_layout.tsx`), 3.2 Shared component: `LabelPreferenceButtons`, 3.3 Hook: `useSetLabelPreference`, 3.4 LabelTile (curate player) — always render when `labelId` present, 3.5 LabelsTable (`/library/:styleId`), 3.6 Library list toolbar — `my` filter (+22 more)
...
Cohesion: 0.09
Nodes (19): CurateSetupPage(), ErrorCtx, handleTransferError(), mapTransferError(), STATUSES, Step1Props, Step2Props, TransferErrorAction (+11 more)
...
Cohesion: 0.07
Nodes (29): 1. Goals, 2. Week convention, 3.1 Migration, 3.2 New endpoints (all admin-gated), 3.3 Reused endpoints, 3.4 Auth, 3.5 API Gateway, 3.6 OpenAPI (+21 more)

### Community 155 - "Community 155"
Cohesion: 0.07
Nodes (29): Architecture, Backend changes, Category Player — Design Spec, CLAUDE.md additions (post-implementation), Data flow, Desktop layout (`min-width: md`), Edge cases, Files deleted (+21 more)

### Community 156 - "Community 156"
Cohesion: 0.07
Nodes (29): 10. Tests, 11. Out of scope, 12. Open questions, 1. Motivation, 1. Run two complementary vendors with the app-targeted prompt, 2. Goal, 2. Merge per-fixture cells into one consensus LabelInfo, 3. Inspect (+21 more)

### Community 157 - "Community 157"
Cohesion: 0.07
Nodes (29): 1. Product Context, 2. Tech Context, 3. Design Direction, 4.1 Base Components, 4.2 Product Components, 4. Component Library, 5. Anchor Scene, 6.1 What to deliver (+21 more)
...
Cohesion: 0.04
Nodes (51): RunCell, RunDetail, RunsListResponse, RunSummary, RunCell, RunDetail, Me, CurateSetupPageProps (+43 more)
...
Cohesion: 0.11
Nodes (18): SessionsTable(), UserDailyTable(), AdminUser, AnalyticsRange, SessionRow, SessionsResponse, UserDailyResponse, UserDailyRow (+10 more)
...
Cohesion: 0.11
Nodes (26): Repositories backed by Aurora Data API., UpsertVendorMatchCmd, VendorTrackMatch, Decimal, _make_repo(), Repository tests for vendor_match_map + match_review_queue (Plan 4 Task 5)., test_get_vendor_match_hit_builds_dataclass(), test_get_vendor_match_miss_returns_none() (+18 more)
...
Cohesion: 0.11
Nodes (7): _cost_result(), Pure shaping helpers for scripts/enrichment_stats.py and scripts/openai_usage_re, Old cells predate web_search_calls/tavily_credits; SQL coalesces them     to 0 b, test_aggregate_costs_sums_usd_and_quantity_by_month_and_line_item(), test_aggregate_usage_sums_tokens_and_requests_by_month_and_model(), test_shape_cells_stats_coalesces_missing_jsonb_keys_on_old_rows(), _usage_result()

### Community 172 - "Community 172"
Cohesion: 0.08
Nodes (25): devDependencies, eslint, eslint-plugin-jsx-a11y, eslint-plugin-react-hooks, globals, jsdom, msw, openapi-typescript (+17 more)
...
Cohesion: 0.09
Nodes (23): dependencies, dayjs, @dnd-kit/core, @dnd-kit/sortable, @dnd-kit/utilities, i18next, @mantine/charts, @mantine/core (+15 more)

### Community 179 - "Community 179"
Cohesion: 0.09
Nodes (22): Affordance, Architecture, Categories: Move and Remove Tracks, Component tests, Data flow, Error handling, Frontend files, Goal (+14 more)
...
Cohesion: 0.13
Nodes (18): ClientError, Retry decorator for RDS Data API client methods.      Retries only on transient, Retry decorator for RDS Data API calls where the operation must     not be re-ex, _retry(), retry_data_api(), retry_data_api_pre_execution(), F, _client_error() (+10 more)
...
Cohesion: 0.10
Nodes (20): a11y checklist (going into `a11y.md`), Acceptance criteria, Architecture of changes, Component spec extension template, Decisions log (from brainstorming), Design Handoff Readiness — iter-2a → Mantine 9, Edits to existing files, Goal (+12 more)
...
Cohesion: 0.19
Nodes (14): _day_window(), export_ops_logs(), lambda_handler(), _ops_records(), _project(), Daily ops/pipeline-health export: enrichment + latency metrics from the worker /, FakeLogs, FakeS3 (+6 more)
...
Cohesion: 0.10
Nodes (19): Adding a new endpoint, Architecture (short version), Backend coordination, CLOUDER frontend, Future: isolated environments, Known dev drift, Local dev hits prod backend, OAuth flow (dev) (+11 more)

### Community 194 - "Community 194"
Cohesion: 0.10
Nodes (19): Автоматический поиск по лейблам — дизайн, Админ-API, Диспетч и дедуп, За рамками этой итерации, Ключевые решения, Контекст: как устроен ручной поиск (переиспользуем), Края и обработка ошибок, Модель данных (+11 more)

### Community 195 - "Community 195"
Cohesion: 0.10
Nodes (19): API surface summary, Architecture principle, Backend (in `auth_handler`, JWT-gated — these require an authenticated user), Component 1 — OAuth (connect a YouTube Music account), Component 2 — Backend publish, Component 3 — Database, Component 4 — Frontend, Decisions (locked) (+11 more)
...
Cohesion: 0.05
Nodes (28): playlist, loadSpotifySdk(), __resetSdkLoaderForTests(), waitForReady(), makeClient(), makeStubAuth(), renderApp(), renderAppWithRouter() (+20 more)

### Community 199 - "Community 199"
Cohesion: 0.09
Nodes (22): API Gateway 29-second hard timeout, Aurora IAM auth flag may not stick via Terraform, AWS resource prefix is `clouder-prod-*`, with a few `beatport-prod-*` survivors, Behavioural Surprises, `bp_token` must never be logged or stored, Concurrency and SQS, Data API at runtime, psycopg only for migrations, Empty artist silently skips vendor match (+14 more)

### Community 200 - "Community 200"
Cohesion: 0.11
Nodes (18): 1.1 `useBucketPlayerQueue(blockId, bucketId, tracks)` — new hook, 1.2 `toPlaybackTrack(BucketTrack)` — shared helper, 1.3 `BucketTrackRow` — add Play affordance, 1.4 `BucketTracksList` — thread playback props, 1.5 `BucketPlayerPanel` — new lean player panel, 1.6 `BucketPlayerPage` — mobile fullscreen route, 1.7 `BucketDetailPage` — wiring, 1.8 Router (+10 more)

### Community 201 - "Community 201"
Cohesion: 0.11
Nodes (18): 1. Goal, 2. What already exists (reused as-is), 3. Decisions, 4. Architecture, 5.1 `providers/ytmusic/lookup.py` — real `YTMusicLookup` (algorithm B), 5.2 Dependency, 5.3 Producer — `vendor_match/enqueue.py` (new helper), 5.4 Backfill — `scripts/backfill_vendor_match.py` (admin-only) (+10 more)

### Community 202 - "Community 202"
Cohesion: 0.21
Nodes (12): User has not yet approved — caller should keep polling., YtmusicAuthPending, YtmusicDeviceCode, _event(), _FakeEnvelope, FakeOAuth, FakeRepo, test_device_code_returns_user_code() (+4 more)
...
Cohesion: 0.06
Nodes (34): ArtistsPanel(), PanelArtist, Props, CategoryPlayerPanel(), CommentsPanel(), Props, PlayerPanelTagCloud(), PlayerPanelTagCloudProps (+26 more)

### Community 205 - "Community 205"
Cohesion: 0.08
Nodes (24): Canonical layer, categories, category_tracks, clouder_albums, clouder_artists, clouder_labels, clouder_styles, clouder_track_artists (+16 more)
...
Cohesion: 0.28
Nodes (10): CellDetailDrawer(), Props, Props, RunDetails(), useCoverage(), cellState, CoverageCell, AdminCoveragePage() (+2 more)
...
Cohesion: 0.11
Nodes (18): 1.5. Tech context update (changes since sprint-1), 1. What sprint-1 already covers (do not redraw), 2. User journey, 3.1 Auth & onboarding, 3.2 Shell, 3.3 Home / Dashboard, 3.4 Categories (Layer 1), 3.5 Triage Blocks (Layer 2) (+10 more)

### Community 213 - "Community 213"
Cohesion: 0.11
Nodes (17): Async flow, `comment_collections` — one row per (track, platform), Data model (Alembic migration), Decisions (resolved during brainstorming), Dispatch hook points, Extensibility architecture (core seam), `external_comments` — the comments, Frontend (+9 more)

### Community 214 - "Community 214"
Cohesion: 0.21
Nodes (9): _event(), test_missing_user_id_400(), test_require_admin_raises_when_no_authorizer(), test_require_admin_raises_when_non_admin(), test_require_admin_returns_user_id_for_admin(), test_route_name_extracts_dashboard(), test_route_name_rejects_unknown_dashboard(), test_sessions_route_queries_fact_session() (+1 more)

### Community 215 - "Community 215"
Cohesion: 0.14
Nodes (9): ClaimingRepo, _event(), FakeS3Client, A batch that dies after claiming must hand its rows back.  Claiming stamps `spot, The stamp has to land before the search, not after it., _setup(), test_claim_is_stamped_before_the_upstream_call(), test_successful_batch_does_not_release() (+1 more)

### Community 216 - "Community 216"
Cohesion: 0.17
Nodes (19): _utc_now(), Record a terminal 'no match found' outcome so the read surface can         retur, Stamp `spotify_searched_at` on the next *limit* candidates and return         th, Hand back rows claimed at *claimed_at* that never got a result.          Rows th, Batch-import Spotify tracks; return one clouder_tracks.id per input.          On, datetime, _utc_now(), _utc_now() (+11 more)
...
Cohesion: 0.12
Nodes (16): Comments on Triage Finalize Implementation Plan, Conventions for every task, Deviations from the spec (intentional simplifications), File overview, Self-review checklist (completed by plan author), Task 10: Show `CommentsPanel` in the category player, Task 11: Full verification, Task 1: Make `CommentCollectMessage.video_id` optional (+8 more)

### Community 221 - "Community 221"
Cohesion: 0.12
Nodes (17): Accessibility, API Contract (recap), Architecture, Error Handling Catalog, Feature folder layout, Goal, i18n, Implementation order (high-level) (+9 more)
...
Cohesion: 0.39
Nodes (6): _fake_parsed(), test_openai_client_built_with_timeout_and_no_retries(), test_openai_returns_error_on_api_exception(), test_openai_returns_error_when_no_parsed(), test_openai_uses_output_parsed(), OpenAIAdapter

### Community 224 - "Community 224"
Cohesion: 0.40
Nodes (16): _ctx(), _event(), _ok_firehose(), test_all_invalid_skips_firehose(), test_batch_over_256_events_returns_400(), test_body_over_256kb_returns_413(), test_bp_token_never_reaches_firehose(), test_emits_flat_typed_shape_no_nested_context_or_props() (+8 more)
...
Cohesion: 0.12
Nodes (15): Cross-increment contracts & reconciliation (read before Task 1), File structure, MUST-FIX compliance map (verify each before requesting review), Phase 1 · Increment 4 — dbt transforms + orchestration — Implementation Plan, Task 0: Branch off origin/main, Task 1: dbt project scaffold + sources + offline `dbt parse` gate, Task 2: Saturday-week macros + `dim_date` (RED→GREEN on the Python mirror), Task 3: Silver staging models (one per event family) + silver tests (+7 more)

### Community 229 - "Community 229"
Cohesion: 0.12
Nodes (15): A. Remove the `is_public` toggle (UI only), Acceptance criteria, B. Backend — enrich the playlist-tracks payload, Background (verified in the codebase), C. Frontend types, D. Playback wiring, Design, E. Player panel — `PlaylistPlayerPanel` (+7 more)

### Community 230 - "Community 230"
Cohesion: 0.12
Nodes (15): A. Cover (`CoverPicker.tsx`), Acceptance criteria, B. Description width (`PlaylistMetaPanel.tsx`), C. Publish button (`PublishButton.tsx`) — softer green, D. Add Tracks button (`PlaylistDetailPage.tsx`) — lower brightness, Design, E. Controls placement (`PlaylistDetailPage.tsx`), F. Search width (`PlaylistDetailPage.tsx`) (+7 more)

### Community 231 - "Community 231"
Cohesion: 0.12
Nodes (15): Aggregation, Artist Information Search — Local Experiment (Design Spec), CLI, Config / vendors, Cost, Data model — `ArtistInfo`, Design decisions (from brainstorming), Directory layout (+7 more)

### Community 232 - "Community 232"
Cohesion: 0.12
Nodes (15): Admin (10 страниц), Artist / Label detail (`ArtistDetailPage`, `LabelDetailPage`), Library lists (`LibraryListPage`, `ArtistsListPage`), Дизайн: единый стиль Library + Admin, Затронутые и новые компоненты, Изменения по областям, Изменённые, Контекст и проблема (+7 more)
...
Cohesion: 0.06
Nodes (42): LabelDetail, LabelSummary, LabelChannelLinks(), LabelDetailHeader(), Props, LabelOverviewTab(), LabelPreferenceButtons(), Props (+34 more)
...
Cohesion: 0.27
Nodes (7): SpotifyNotFoundTable(), RetryInput, RetryResponse, useRetrySpotifySearch(), SpotifyNotFoundItem, useSpotifyNotFound(), AdminSpotifyNotFoundPage()
...
Cohesion: 0.13
Nodes (14): 1. `NODE_OPTIONS=--no-experimental-webstorage`, 2. `notifyManager.setScheduler(queueMicrotask)`, 3. `import '../i18n'`, 4. `ResizeObserver` + `Element.prototype.scrollIntoView` stubs, 5. `Element.prototype.getBoundingClientRect` stub + non-zero `window.innerWidth/Height`, Additional shims in setup.ts (not in CLAUDE.md checklist), Frontend Testing Guide, Mantine in tests (+6 more)

### Community 241 - "Community 241"
Cohesion: 0.13
Nodes (13): Architecture, Component Layout, Errors (extensions to `errors.py`), IAM (Terraform), Integration (ephemeral Postgres), Layer responsibilities, Out of Scope / Future Work, Playlists (Backend) — Design (+5 more)

### Community 242 - "Community 242"
Cohesion: 0.13
Nodes (14): 10. Secrets & Config, 11. Out of Scope, 12. Open Questions, 1. Motivation, 2. Goal, 3. Directory Layout, 4. Schemas, 5. Prompt Contract (+6 more)

### Community 243 - "Community 243"
Cohesion: 0.13
Nodes (14): 1. Restrict the triage player to staging buckets, 2. Width parity for the triage player, 3. Unified layout + Chip-style distribution buttons (both players), 3a. `BucketDistributeButtons` → Chip style, 3b. `BucketPlayerPanel` layout, 3c. `CategoryPlayerPanel` layout (reorder only), Background — current state, Data flow & edge cases (+6 more)

### Community 244 - "Community 244"
Cohesion: 0.13
Nodes (14): API, Classification, Decisions, Frontend, Goal, Problem, Pure mirror, Schema migration (+6 more)
...
Cohesion: 0.18
Nodes (8): _Cell, _execute_cell(), _new_run_id(), Matrix runner: prompts × vendors × fixtures → JSON cells + manifest., Drop Authorization-like fields from raw responses before persisting., run_matrix(), RunResult, _safe()

### Community 250 - "Community 250"
Cohesion: 0.20
Nodes (9): export_catalog(), _ndjson(), _empty_tables(), FakeDataAPI, FakeS3, Mimics DataAPIClient.execute with offset paging over canned rows., test_empty_table_writes_no_object(), test_ndjson_serializes_dates_via_default_str() (+1 more)
...
Cohesion: 0.15
Nodes (21): test_run_exception_path(), test_run_returns_error_when_no_tool_use(), _make_grounding_chunk(), _mock_response(), Tests for GeminiFlashAdapter using injected fake clients., 503 UNAVAILABLE errors are retried with exponential backoff., Quota errors are retried; success on the third attempt counts as ok., When grounding_metadata has no URLs, copy parsed.sources into citations. (+13 more)

### Community 253 - "Community 253"
Cohesion: 0.12
Nodes (12): EndOfQueue(), EndOfQueueProps, FinalizeModalProps, TransferModalProps, TriageBlockHeader(), TriageBlockHeaderProps, CurateSession, TriageBlock (+4 more)

### Community 254 - "Community 254"
Cohesion: 0.20
Nodes (9): Analytics v2 — Envelope Redesign Implementation Plan (Plan 1 of 4), File Structure, Self-Review, Task 1: Delete the dead dbt analytics layer, Task 2: Flatten `validate_event` to the typed-hybrid shape, Task 3: Emit the flat shape from the handler, Task 4: Retype the `bronze_events` Glue table, Task 5: Instrument `removed_from_category` on the frontend (+1 more)

### Community 255 - "Community 255"
Cohesion: 0.14
Nodes (13): File structure, Task 10: Full suite + gates + finish, Task 1: `api()` `{suppressAuthFailure}` option (lands first; opens the branch), Task 2: Telemetry SDK core (`sdk.ts`) + env flag + app_version + privacy lint rule, Task 3: Register the `/v1` API prefix (CloudFront + Vite proxy), Task 4: Telemetry hooks (`hooks.ts`), Task 5: Playback — `PlaybackSource` + `play()` source arg + `playback_play`/`playback_seek` emits, Task 6: Triage — `track_view`, session start/end, categorize, undo (+5 more)

### Community 256 - "Community 256"
Cohesion: 0.14
Nodes (14): 10. Process, 1. Why this exists, 2. What stays from sprint-1 (do not redo), 3. Vocabulary map (sprint-1 base catalog → Mantine), 4. New Mantine-native components to specify, 5.1 `tokens.css`, 5.2 `theme.ts` — MantineProvider theme object, 5. MantineProvider theme export (+6 more)

### Community 257 - "Community 257"
Cohesion: 0.14
Nodes (13): 1.1 `BucketDistributeButtons` — new presentational component, 1.2 `useBucketDistribute` — new hook, 1.3 `BucketPlayerPanel` — wire in distribution, 1. Components, 2. Data flow, 3. Error handling & edge cases, 4. Testing (TDD), 5. Files touched (+5 more)
...
Cohesion: 0.08
Nodes (28): Action, AuthContext, AuthContextValue, AuthState, CallbackResponse, getAuthSnapshot(), RefreshResponse, snapshot (+20 more)
...
Cohesion: 0.13
Nodes (14): Enrichment Split Experiment Implementation Plan, File Structure, Global Constraints, Self-Review Notes, Task 10: LIVE runs + experiment report + go/no-go, Task 1: Scaffold the sandbox package, Task 2: Request schemas — narrative and facts, Task 3: Profile-URL regex extraction + handle validation (+6 more)

### Community 267 - "Community 267"
Cohesion: 0.15
Nodes (13): scripts, api:types, build, dev, format, lint, lint:fix, preview (+5 more)
...
Cohesion: 0.15
Nodes (12): File Structure, Self-Review, Task 1: Observability — log dispatch counts + a `started` marker, Task 2: Set-based artist resolve — `get_artists_by_ids`, Task 3: Set-based label resolve — `get_labels_by_ids` + `derive_styles_for_labels`, Task 4: Set-based `claim_artists` (preserve race-safety semantics), Task 5: Set-based `claim_labels` (mirror of Task 4), Task 6: Set-based `attach_run` in both auto-repositories (+4 more)

### Community 271 - "Community 271"
Cohesion: 0.15
Nodes (12): Acceptance (maps to §17 step 5 + §14 checklist), File structure, Phase 1 · Increment 5 — Serving (analytics-api + dashboards) — Implementation Plan, Task 1: Backend — admin gate, route resolution, param validation, query building (pure, no I/O), Task 2: Backend — Athena execution, result reuse, lru_cache, `lambda_handler`, Task 3: OpenAPI — 5 `/v1/analytics/*` ROUTES + `AnalyticsResult` schema, regenerate openapi.yaml + schema.d.ts, Task 4: Infra — `infra/analytics_routes.tf` (standalone Lambda, dedicated role, 5 admin-gated routes), Task 5: Infra/Frontend — register the `/v1` API prefix (CloudFront + Vite dev proxy) — THE BLOCKER (+4 more)

### Community 272 - "Community 272"
Cohesion: 0.15
Nodes (12): 1. Goal, 2. Decisions, 3. Flow, 4. Backend (curation Lambda, per-user), 5. Frontend, 6. Error handling, 7. Testing, 8. Files (anticipated) (+4 more)

### Community 273 - "Community 273"
Cohesion: 0.15
Nodes (12): Approach (chosen: both, sequential), Components & data flow, Error handling, Observability fix (with Phase 1), Out of scope, Phase 1 — Optimize the inline dispatch (ship first, unblocks prod, no new infra), Phase 2 — Move dispatch off the request path (durability), Problem (+4 more)

### Community 274 - "Community 274"
Cohesion: 0.29
Nodes (7): FakeRepo, FakeSqs, _patch(), test_dispatch_no_queue_url_does_not_raise_and_sends_nothing(), test_dispatch_sends_for_empty_video(), test_dispatch_sends_message_for_new_collection(), test_dispatch_skips_when_already_collected()

### Community 275 - "Community 275"
Cohesion: 0.18
Nodes (8): TransferBlockOption(), TransferBlockOptionProps, TriageBlockRow(), TriageBlockRowProps, TriageBlockSummary, block, block, server

### Community 276 - "Community 276"
Cohesion: 0.46
Nodes (7): _ctx(), _event(), Integration tests for GET /admin/users., reset_caches(), test_users_db_not_configured_503(), test_users_requires_admin(), test_users_returns_list()
...
Cohesion: 0.10
Nodes (23): Clear spotify_searched_at for not-found tracks in the publish-date         range, date, cutoff_date(), fetch(), main(), _print_cells_table(), _print_instagram_table(), Thin execute_statement wrapper: JSON-formatted rows, resume-retry.      Aurora S (+15 more)

### Community 279 - "Community 279"
Cohesion: 0.42
Nodes (9): _ctx(), _event(), Integration tests for GET /admin/coverage., reset_caches(), test_coverage_db_not_configured_503(), test_coverage_merges_spotify_weeks(), test_coverage_missing_week_year_400(), test_coverage_requires_admin() (+1 more)
...
Cohesion: 0.17
Nodes (11): CLOUDER · iter-2a · Design handoff, Contact, Design language quick reference, Frame compatibility, How to read these in order, Implementation priorities, iter-2a decisions (locked 2026-04-29), Setup (+3 more)
...
Cohesion: 0.17
Nodes (11): File structure, Task 0: Branch, Task 1: Envelope validation (`telemetry_schemas.py`), Task 2: Telemetry handler (`telemetry_handler.py`), Task 3: OpenAPI `/v1/telemetry` route + `TelemetryEnvelope` component, Task 4: Register the `/v1` prefix in CloudFront + Vite (MUST-FIX 1), Task 5: `infra/telemetry.tf` — Lambda + role + Firehose + S3 lake + Glue + outputs, Task 6: Integration smoke (one-shot, against a deployed stack) (+3 more)

### Community 286 - "Community 286"
Cohesion: 0.17
Nodes (11): Acceptance criteria, Background / root cause, Category Tags UX — Design, Colors, Design, Goal, Hotkeys, Out of scope (+3 more)

### Community 287 - "Community 287"
Cohesion: 0.17
Nodes (11): #1 — pin the chip label padding (category player), #1 — why the chip changes size, #2 — uniform short pills (global TagPill), #2 — why short pills differ in width, Acceptance criteria, Background / root cause, Design, Goal (+3 more)

### Community 288 - "Community 288"
Cohesion: 0.17
Nodes (11): Architecture / changes, Data flow (search button), Decisions, Error handling, Files touched (summary), Improve artists — design, Non-goals, Part 1 — Frontend player parity (covers gaps 1 & 2) (+3 more)

### Community 289 - "Community 289"
Cohesion: 0.17
Nodes (11): ADR authoring rules, Architectural → feed an ADR (17 specs → 5 ADRs), Commit, Cosmetic / feature → archived only, no ADR (12 batch specs + this spec), Current state (verified), Documentation Cleanup + ADR Backfill (round 2) — Design Spec, File operations, Goal (+3 more)
...
Cohesion: 0.20
Nodes (13): FakeS3Client, Tests for SQS worker lambda: message parsing, error classification, happy path., StorageError (permanent) should NOT re-raise → SQS deletes the message., RuntimeError (transient) should re-raise → SQS retries the message., _setup_worker(), _sqs_event(), test_happy_path_processes_tracks(), test_invalid_sqs_json_payload_is_skipped() (+5 more)

### Community 294 - "Community 294"
Cohesion: 0.25
Nodes (10): SpotifyProfile, SpotifyTokenSet, FakeOAuth, _event(), test_callback_admin_user_gets_is_admin_true(), test_callback_non_premium_returns_403_without_db_writes(), test_callback_oauth_exchange_failure_returns_502(), test_callback_premium_user_creates_session_and_returns_jwt() (+2 more)
...
Cohesion: 0.15
Nodes (11): CreateTriageBlockInput, PendingCreateError, STATUSES, UseCreateOptions, DEFAULT_DELAYS, PendingCreatePayload, PendingPage, ScheduleArgs (+3 more)
...
Cohesion: 0.18
Nodes (10): File Structure, Self-Review, Task 1: Block-level enqueue helper, Task 2: Dispatch worker handler, Task 3: Finalize enqueues instead of dispatching inline, Task 4: Terraform — names, queue + DLQ, variables, Task 5: Terraform — worker Lambda, log group, event-source mapping, alarm, Task 6: Terraform — IAM + curation env wiring (+2 more)
...
Cohesion: 0.12
Nodes (33): normalize_text(), NormalizedAlbum, NormalizedArtist, NormalizedLabel, NormalizedStyle, NormalizedTrack, _as_date_str(), _as_key() (+25 more)
...
Cohesion: 0.14
Nodes (13): Enrichment Prod v2 Implementation Plan (AI-off + socials post-pass), File Structure, Global Constraints, Rollout (after merge — owner-gated, not part of the tasks), Self-Review Notes, Task 1: Request schemas + storage defaults (label + artist), Task 2: Prompts v4/v2_no_ai + registry defaults, Task 3: OpenAI adapter knobs + instrumentation + honest pricing (+5 more)
...
Cohesion: 0.18
Nodes (10): 1. Collapsible main navbar (desktop), 2. Narrow both players to 442px, 3. Highlight the playing track in the category player, Decisions (from brainstorming), Desktop Design Tweaks — Design Spec, Edge cases, Files touched, Goal (+2 more)

### Community 311 - "Community 311"
Cohesion: 0.18
Nodes (10): 1. Category player — `CategoryPlayerPanel.module.css`, 2. Triage player — `BucketPlayerPanel.tsx`, Background — current state, Decisions (from brainstorming), Edge cases, Files touched, Goal, Out of scope (+2 more)

### Community 312 - "Community 312"
Cohesion: 0.18
Nodes (10): 1. Table Tags column → read-only, 2. Player Tags block → add "+" with the full popover, Background — current state, Data flow & edge cases, Decisions (from brainstorming), Files touched, Goal, Move Tag-Adding to the Player — Design Spec (+2 more)

### Community 313 - "Community 313"
Cohesion: 0.18
Nodes (10): Approaches considered, Backend changes, Clipboard JSON format, Copy Playlist as JSON — Design, Data loading, Error handling, Frontend changes, Goal (+2 more)

### Community 315 - "Community 315"
Cohesion: 0.45
Nodes (10): _base_parsed(), _cell(), _fake_deepseek_client(), test_deterministic_median_numeric(), test_filter_parseable_drops_errors_and_nulls(), test_majority_with_unknown_abstention(), test_merge_cells_all_failed(), test_merge_cells_multiple_sources_runs_narrative() (+2 more)
...
Cohesion: 0.17
Nodes (3): SessionRow, _to_session_row(), FakeRepo

### Community 319 - "Community 319"
Cohesion: 0.05
Nodes (55): BucketPlayerPanel(), BucketPlayerPanelProps, BucketTrackRow(), track, BucketTracksListProps, CurateCard(), CurateCardProps, formatBpm() (+47 more)
...
Cohesion: 0.20
Nodes (9): Conventions for every task, File structure, Self-review notes (already reconciled), Task 1: Cover — insert with update fallback, Task 2: Client `move_item` method, Task 3: Reorder sync in publish service, Task 4: Flag ytmusic republish on reorder, Task 5: Full regression run (+1 more)

### Community 324 - "Community 324"
Cohesion: 0.20
Nodes (10): `AddTracksModal` (from categories), Component Designs, `CoverPicker`, Cross-feature: `Add to playlist` submenu, Detail page (`PlaylistDetailPage.tsx`), `DriftBadge`, `ImportSpotifyModal`, List page (`PlaylistsListPage.tsx`) (+2 more)

### Community 325 - "Community 325"
Cohesion: 0.20
Nodes (9): 1. Triage `BucketDistributeButtons` — Chip → Button, 2. Category `PlayerPanelPlaylistCloud` — Chip → Button (2 per row), Background — current state, Data flow & edge cases, Distribution Buttons Style — Design Spec, Files touched, Goal, Out of scope (+1 more)

### Community 326 - "Community 326"
Cohesion: 0.20
Nodes (9): #1 — Hide the tag checkmark (category player), #2 — Remove the focus ring app-wide, Acceptance criteria, Background, Design, Goal, Out of scope, Remove Focus Ring + Tag Checkmark — Design (+1 more)

### Community 327 - "Community 327"
Cohesion: 0.20
Nodes (9): Decisions, Empirical grounding (measured), Non-goals (YAGNI), Open items for the implementation plan, Problem, Resolver integration, Testing, The matcher (pure, no network) (+1 more)

### Community 328 - "Community 328"
Cohesion: 0.36
Nodes (9): PUT /labels/{id}/preference + GET /me/label-preferences., test_get_my_label_preferences_passes_user_id(), test_label_detail_forwards_user_id(), test_labels_list_forwards_my_and_user_id(), test_put_pref_404_when_label_missing(), test_put_pref_422_on_invalid_status(), test_put_pref_liked_calls_upsert(), test_put_pref_none_calls_delete() (+1 more)

### Community 329 - "Community 329"
Cohesion: 0.22
Nodes (3): _load_migration_module(), Test that the triage migration creates the expected schema., test_revision_metadata()
...
Cohesion: 0.05
Nodes (26): ClouderRepository, Read-only peek used to decide whether a follow-up batch is needed.          Must, Copy release_type from tracks onto their parent albums.          Runs a single U, UpdateSpotifyResultCmd, UpsertSourceEntityCmd, SpotifySearchMessage, _enqueue_follow_up_if_needed(), _extract_message_attribute() (+18 more)
...
Cohesion: 0.25
Nodes (14): FactsResult, merge_passes(), Union-merge of the two passes. Fields are designed not to overlap; on accidental, NarrativeResult, run_experiment(), test_facts_never_overwrite_narrative_keys(), test_merge_unions_all_three_sources(), test_null_profile_values_get_no_provenance() (+6 more)
...
Cohesion: 0.10
Nodes (19): aggregates, filters_applied, groups, merged_at, total_aggregate_cost_usd, fixtures, prompts, vendors (+11 more)
...
Cohesion: 0.17
Nodes (11): Global Constraints, Spotify Coverage Stats + Not-Found Retry Implementation Plan, Task 1: Repository — `spotify_stats_for_year`, Task 2: Coverage handler merges `spotify_weeks`, Task 3: Repository — retry reset, pending count, date filters on not-found list, Task 4: `GET /tracks/spotify-not-found` — publish-date query params, Task 5: `POST /admin/spotify/retry-not-found` endpoint, Task 6: Route registration — Terraform + OpenAPI + generated types (+3 more)

### Community 340 - "Community 340"
Cohesion: 0.22
Nodes (8): Adding a prompt, Adding a vendor, Concurrency, Label AI Sandbox, Recommended pipeline, Run, Setup, Tests

### Community 341 - "Community 341"
Cohesion: 0.22
Nodes (8): API Lambda (`clouder-prod-collector-api`), Aurora PostgreSQL logs, Canonicalization worker (`clouder-prod-canonicalization-worker`), Logs, Migration Lambda (`clouder-prod-db-migration`), Spotify search worker (`clouder-prod-spotify-search-worker`), Structlog events, Tailing Lambda logs
...
Cohesion: 0.25
Nodes (7): Analytics v2 — Frontend Dashboard Implementation Plan (Plan 4 of 4), Backend contract (already shipped), File Structure, Self-Review, Task 1: Regenerate the typed client + rewrite the hooks, Task 2: Rebuild the page + components + i18n + tests, Task 3: Refresh graphify + verify
...
Cohesion: 0.10
Nodes (27): mart_sql(), Sessionization rollup SQL for the analytics v2 marts.  One SQL source, two diale, SQL selecting one row per derived session (fact_session grain)., SQL selecting one row per (user_id, dt, activity_type) — mart_user_daily grain., Shared classified→events→gapped→sessioned CTE block (no leading WITH)., create_default_athena_client(), create_default_s3_client(), _delete_partition() (+19 more)

### Community 355 - "Community 355"
Cohesion: 0.17
Nodes (11): 1. The Instagram mechanism works — this was the experiment's main question, 2. The facts pass does NOT replace agentic search for numbers, 3. `max_tool_calls` is a soft cap, 4. Reliability, Enrichment split experiment — report & go/no-go, Gate tables, Key findings, Recommendation for the prod plan (+3 more)
...
Cohesion: 0.18
Nodes (3): ArtistContext, Disambiguation context from the artist's tracks: dominant style,         up to 3, FakeRepo
...
Cohesion: 0.25
Nodes (8): Alter `clouder_tracks`, Data Model, Limits (service-layer validation), Migration 19 — `20260512_19_playlists.py`, New table `playlist_tracks`, New table `playlists`, New table `user_imported_tracks`, `normalized_name`
...
Cohesion: 0.15
Nodes (12): cap, kinds, retried_timeouts, retry_replaced, run_id, totals, cost_usd, entities (+4 more)
...
Cohesion: 0.25
Nodes (8): Analytics first run (bootstrap) — superseded, Cold-start 503, DLQ messages, Lambda reserved concurrency trip, `processing_status=FAILED_TO_QUEUE`, Refresh-cookie replay revocation, Runbook, Running a one-off script against prod
...
Cohesion: 0.38
Nodes (3): FakeRepo, test_get_auto_config_returns_defaults(), test_put_auto_config_persists_with_artists_kind()
...
Cohesion: 0.05
Nodes (47): AnthropicClaudeAdapter, Anthropic Claude adapter., Best-effort serialization for the `raw` field. SDK objects vary in shape., _to_dict(), xAI Grok adapter via the Responses API., Best-effort serialization for the `raw` field.      SDK Response objects use Typ, _to_dict(), XAIGrokAdapter (+39 more)
...
Cohesion: 0.16
Nodes (13): PlaylistsRepository, Persist publish-state.          When ``mark_dirty`` is True we still record the, Record the YouTube Music playlist id + publish timestamp and clear         the y, test_clear_cover_returns_true_when_affected(), FakeDataAPI, test_fetch_unmatched_excludes_already_attempted_in_sql(), test_fetch_unmatched_maps_multiple_rows(), test_fetch_unmatched_maps_null_fields() (+5 more)
...
Cohesion: 0.53
Nodes (5): _add_track_event(), _finalize_event(), test_add_track_no_artist_dispatch_when_already_present(), test_add_track_triggers_artist_dispatch_for_track(), test_finalize_enqueues_block_auto_enrich()

### Community 413 - "Community 413"
Cohesion: 0.53
Nodes (5): _add_track_event(), _finalize_event(), test_add_track_no_dispatch_when_already_present(), test_add_track_triggers_dispatch_for_track(), test_finalize_enqueues_block_auto_enrich()

### Community 414 - "Community 414"
Cohesion: 0.53
Nodes (5): GET /labels/{id} returns sanitized LabelInfo for completed labels., test_get_label_user_returns_404_when_label_missing(), test_get_label_user_returns_minimal_payload_when_not_completed(), test_get_label_user_returns_sanitized_payload(), _user_event()
...
Cohesion: 0.24
Nodes (7): AddToPlaylistSubmenu(), AddToPlaylistSubmenuProps, HOTKEY_LABELS, PlayerPanelPlaylistCloud(), PlayerPanelPlaylistCloudProps, usePlaylists(), mockPlaylists
...
Cohesion: 0.23
Nodes (5): PlaylistRow, Metadata for tracks not yet matched to `vendor`, ready to enqueue., Per-track YT Music status. matched > needs_review > not_found > pending., Partial update. None values mean "leave as is".          If the row is already p, _row()
...
Cohesion: 0.33
Nodes (10): _analytics_route(), build_openapi(), _build_server(), _collect_pydantic_schemas(), _error(), main(), _make_response(), _operation() (+2 more)

### Community 436 - "Community 436"
Cohesion: 0.50
Nodes (4): _event(), PUT /labels/{id}/preference + GET /labels/{id} round trip., The user sets a preference; the next GET surfaces it., test_put_then_get_label_returns_my_preference()
...
Cohesion: 0.29
Nodes (7): _ctx(), FakeKms, End-to-end auth flow with in-memory fakes for KMS, OAuth, repo., In-memory KMS envelope: identity-encrypts. Sufficient to verify wiring., test_full_login_to_logout_flow(), test_non_premium_blocks_at_callback(), _wire()
...
Cohesion: 0.04
Nodes (68): _build_auto_repository(), AutoEnrichRepository, lambda_handler(), Daily Aurora catalog snapshot to the analytics lake (bronze/catalog_export/).  R, _playlists_factory(), _triage_factory(), create_default_data_api_client(), Thin wrapper over AWS RDS Data API. (+60 more)

### Community 442 - "Community 442"
Cohesion: 0.70
Nodes (4): _admin_event(), test_auto_config_requires_admin(), test_get_auto_config_routed(), test_put_auto_config_routed_returns_204()

### Community 443 - "Community 443"
Cohesion: 0.60
Nodes (4): _admin_event(), GET /admin/labels/{label_id}/history exposes per-label cell history., test_label_history_requires_admin(), test_label_history_returns_items()
...
Cohesion: 0.60
Nodes (4): _load_migration(), _read_source(), test_revision_metadata(), test_upgrade_creates_user_sessions_table()

### Community 449 - "Community 449"
Cohesion: 0.60
Nodes (4): _load_migration(), _read_source(), test_revision_metadata(), test_upgrade_creates_user_vendor_tokens_table()
...
Cohesion: 0.11
Nodes (11): _batch_data_api(), Regression for C1: a Spotify playlist can legitimately contain the     same trac, Regression: same Data API constraint as scope-check — the dedup SELECT     insid, Status flip is organizational, not Spotify-visible — must not mark drift., Regression: Aurora Data API failed status-only patches with     `could not deter, Data API fake that records execute/batch_execute calls., test_append_tracks_dedups_intra_input_duplicates(), test_append_tracks_uses_parametric_in_list_for_dedup_check() (+3 more)
...
Cohesion: 0.50
Nodes (4): Delete, Read flow, S3 Layout for Covers, Upload flow
...
Cohesion: 0.67
Nodes (3): _admin_event(), GET /admin/labels/enrich/options exposes vendors + prompts for FE form., test_enrich_options_payload_shape()

### Community 477 - "Community 477"
Cohesion: 0.67
Nodes (3): _admin_event(), GET /admin/labels/enrich-runs/{run_id} now includes cells[]., test_run_detail_includes_cells()
...
Cohesion: 0.17
Nodes (11): Fixture: ambiguous-trap, Fixture: anjunadeep, Fixture: drumcode, Fixture: hessle-audio, Fixture: obscure-niche-2, Fixture: suno-style-label, Fixture: synthetic-ai-trap, Fixture: wisdom-teeth (+3 more)
...
Cohesion: 0.29
Nodes (6): _b64d(), _b64e(), _OAuthClientLike, _parse_expires_at(), Read + KMS-decrypt + refresh the user's Spotify OAuth access token.  Storage sha, ResolvedSpotifyToken
...
Cohesion: 0.33
Nodes (6): homeActiveBlocksKey(), homeActiveBlocksQueryOptions(), HomeData, UseHomeDataResult, Style, PaginatedTriageBlocks

### Community 561 - "Community 561"
Cohesion: 0.22
Nodes (8): Prompt registry (process-wide). Built-ins self-register on import., Import the built-in prompt modules so they self-register., Return all loaded prompt registry entries as serializable dicts.      Default se, label_v4_no_ai — label_v3_app_fields minus every AI-detection mention., get_prompt(), list_prompt_versions(), load_builtin_prompts(), register()

### Community 564 - "Community 564"
Cohesion: 0.04
Nodes (61): api(), ApiInit, notifyAuthFailure(), RefreshResponse, tryRefreshOnce(), StatusBadge(), StatusBadgeProps, YtMusicBadge() (+53 more)
...
Cohesion: 0.22
Nodes (5): ArtistInfoRequest, Vendor-facing schema: ArtistInfo minus AI-detection fields.      Structured outp, LabelInfoRequest, Vendor-facing schema: LabelInfo minus AI-detection fields.      Structured outpu, test_request_payload_validates_into_storage_via_defaults()
...
Cohesion: 0.33
Nodes (5): artist (50 entities, 0 errors), Enrichment split experiment — run 20260715-212849-239f (cap=2), Gate (spec §5), Instagram handles for manual spot-check, label (50 entities, 0 errors)

### Community 578 - "Community 578"
Cohesion: 0.33
Nodes (5): artist (50 entities, 0 errors), Enrichment split experiment — run 20260716-035040-e51f (cap=1), Gate (spec §5), Instagram handles for manual spot-check, label (50 entities, 0 errors)
...
Cohesion: 0.31
Nodes (5): ResumeHero(), ResumeHeroProps, ResumeSession, ResumeTarget, block
...
Cohesion: 0.25
Nodes (7): artist_v2_no_ai — artist_v1 minus every AI-detection mention., Import the built-in prompt modules so they self-register., Return all loaded prompt registry entries as serializable dicts.      Default se, get_prompt(), list_prompt_versions(), load_builtin_prompts(), register()
...
Cohesion: 0.28
Nodes (7): BLOCKER_BLOCK, FINALIZED_BLOCK, makeClient(), mountBucketDetail(), mountTriageDetail(), STAGING_BLOCK, TARGET_BLOCK
...
Cohesion: 0.38
Nodes (5): _lat(), OpenAI GPT adapter via the Responses API., _to_dict(), _zero_usage(), Best-effort serialization for the `raw` field.      SDK Response objects use Typ

### Community 594 - "Community 594"
Cohesion: 0.48
Nodes (5): _event(), test_delete_session_belonging_to_other_user_returns_404(), test_delete_session_current_returns_400(), test_delete_session_revokes_non_current(), test_get_me_returns_user_and_sessions()
...
Cohesion: 0.48
Nodes (5): _fake_response(), test_gemini_handles_fenced_json(), test_gemini_parses_valid_payload(), test_gemini_returns_error_on_api_exception(), GeminiAdapter

### Community 597 - "Community 597"
Cohesion: 0.52
Nodes (5): FakeResponses, make_adapter(), test_bad_request_on_knobs_retries_bare(), test_empty_effort_not_sent_and_default_cap(), test_knobs_passed_and_usage_instrumented()
...
## Knowledge Gaps
- **2945 isolated node(s):** `neutral`, `magenta`, `ClouderTheme`, `MantineThemeOther`, `run_id` (+2940 more)
...
- **Why does `api()` connect `Community 564` to `Community 259`, `Auto-Enrich Config (FE API)`, `Community 133`, `Bucket Player UI`, `Playlist/Bucket Track Rows`, `Spotify Backend Client`, `Frontend API Errors & Types`, `Community 275`, `Community 152`, `Home Dashboard UI`, `Auto-Enrich Repository`, `Community 160`, `Community 33`, `Community 164`, `Community 36`, `Community 38`, `Community 42`, `Community 298`, `Community 430`, `Community 46`, `Community 560`, `Community 52`, `Community 319`, `Community 65`, `Community 80`, `Community 234`, `Community 238`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `log_event()` connect `Curation API Handler` to `Playlists UI`, `API Route Handlers (admin/enrich)`, `KMS Envelope & Auth Crypto`, `Community 395`, `Community 396`, `Admin Artist API Types`, `Community 269`, `Enrichment Data Models`, `Backend Error Hierarchy`, `Admin Label API Types`, `Auth Handler & Settings`, `Provider Protocols`, `Enrichment Orchestrator`, `Community 163`, `Community 41`, `Community 554`, `Community 44`, `Community 428`, `Community 181`, `Community 55`, `Community 441`, `Community 569`, `Community 189`, `Community 62`, `Community 67`, `Community 197`, `Community 72`, `Community 73`, `Community 76`, `Community 332`, `Community 217`, `Community 235`, `Community 250`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `_event()` connect `Community 83` to `API Route Handlers (admin/enrich)`?**
...
- **Should `Curation API Handler` be split into smaller, more focused modules?**
  _Cohesion score 0.07413213885778276 - nodes in this community are weakly interconnected._
- **Should `API Route Handlers (admin/enrich)` be split into smaller, more focused modules?**
  _Cohesion score 0.07026055705300989 - nodes in this community are weakly interconnected._