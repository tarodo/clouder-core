# Graph Report - spotify-coverage-retry  (2026-07-13)

## Corpus Check
- 1241 files · ~745,503 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9611 nodes · 19517 edges · 531 communities (483 shown, 48 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 956 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ee15e4f8`
...
1. `lambda_handler()` - 122 edges
2. `log_event()` - 118 edges
3. `server` - 95 edges
4. `api()` - 94 edges
5. `DataAPIClient` - 87 edges
6. `tokenStore` - 86 edges
7. `PlaylistsRepository` - 80 edges
8. `ClouderRepository` - 70 edges
9. `TriageRepository` - 66 edges
10. `ValidationError` - 65 edges
...
- `test_curation_error_response_logs_5xx_with_status_and_reason()` --calls--> `YtmusicApiError`  [INFERRED]
  tests/unit/test_curation_error_response.py → src/collector/curation/__init__.py
...
## Communities (531 total, 48 thin omitted)

### Community 0 - "Playlists UI"
Cohesion: 0.04
Nodes (59): Pure helpers for spec-C categories: normalization, validation, reorder checks., Ensure the requested id list equals the actual alive set, no dups.      Used by, validate_reorder_set(), ConfirmOverwriteRequiredError, CoverMissingError, CoverTooLargeError, CurationError, InactiveBucketError (+51 more)

### Community 1 - "Curation API Handler"
Cohesion: 0.08
Nodes (86): _safe(), try_dispatch_artists_for_track(), _build_s3_storage(), _build_spotify_user_client(), _build_storage_if_needed(), _category_response(), _comments_factory(), _create_triage_block() (+78 more)

### Community 2 - "API Route Handlers (admin/enrich)"
Cohesion: 0.08
Nodes (73): ApiSettings, RunSpec, _build_auto_repository(), _build_repository(), _build_sqs_client(), _extract_user_id(), handle_get_artist(), handle_get_artist_history() (+65 more)

### Community 3 - "Admin Coverage/Enrich UI"
Cohesion: 0.07
Nodes (30): CurateSetupPage(), CurateSetupPageProps, EndOfQueue(), EndOfQueueProps, ErrorCtx, handleTransferError(), mapTransferError(), STATUSES (+22 more)

### Community 4 - "Auto-Enrich Config (FE API)"
Cohesion: 0.07
Nodes (38): _build_narrative_prompt(), _filter_parseable(), _highest_confidence_cell(), _merge_deterministic(), _merge_narrative(), _rank_list_round_robin(), Multi-vendor consensus aggregator for ArtistInfo cells.  The single public entry, Assemble the user message from all parseable cells' narrative fields. (+30 more)

### Community 5 - "KMS Envelope & Auth Crypto"
Cohesion: 0.07
Nodes (18): Canonicalizer, _chunks(), _identity_cmd(), ConservativeUpdateTrackCmd, CreateTrackCmd, IdentityMapEntry, parse_iso_date(), UpsertIdentityCmd (+10 more)

### Community 6 - "Library Artist/Label UI"
Cohesion: 0.04
Nodes (40): Any, AnalyticsError, build_queries(), _cached_rows(), _client(), _correlation_id(), create_default_athena_client(), lambda_handler() (+32 more)

### Community 7 - "Artist Enrichment Repository"
Cohesion: 0.04
Nodes (25): CategoryDetailHeader(), CategoryDetailHeaderProps, BucketDetailPage(), BLOCK, TRACK, TriageDetailPage(), bindQueueSpy, inProgressBlock (+17 more)

### Community 8 - "Triage Finalize UI"
Cohesion: 0.09
Nodes (34): AppleExporter, DeezerExporter, Protocol, EnrichProvider, ExportProvider, IngestProvider, LookupProvider, ProviderBundle (+26 more)

### Community 9 - "Bucket Player UI"
Cohesion: 0.06
Nodes (24): get_prompt(), load_builtin_prompts(), Import the built-in prompt modules so they self-register.      Safe to call mult, register(), label_v2_facts — facts-discipline prompt: numbers, sources, no guessing., label_v3_app_fields — label_v2_facts plus logo, socials, tagline for app integra, _build_narrative_prompt(), _filter_parseable() (+16 more)

### Community 10 - "Curation Error Types"
Cohesion: 0.08
Nodes (22): RunCell, RunDetail, RunsListResponse, RunSummary, RunCell, RunDetail, ArtistRunDetailCellsTable(), ArtistRunDetailHeader() (+14 more)

### Community 11 - "Playlist/Bucket Track Rows"
Cohesion: 0.11
Nodes (7): MoveTracksIn, TransferTracksIn, Test Pydantic schemas for spec-D triage requests/responses., TestCreateTriageBlockInPopulateOptions, TestExtraFieldsRejected, TestMoveTracksIn, TestTransferTracksIn
...
Cohesion: 0.05
Nodes (29): AuthContextValue, loadSpotifySdk(), __resetSdkLoaderForTests(), waitForReady(), makeClient(), makeStubAuth(), renderApp(), RenderAppOpts (+21 more)

### Community 14 - "Enrichment Data Models"
Cohesion: 0.14
Nodes (16): SpotifyAuthError, SpotifyUnavailableError, Spotify Web API client with Client Credentials auth and retry semantics., Spotify text search fallback when ISRC lookup returned no items.          Builds, Try ISRCs that differ from the query by ±1, ±2 in the last digit.          Sibli, Search Spotify for a single track by ISRC.          Fetches up to 10 results and, Authenticate or reuse cached token., Obtain access token via Client Credentials flow. (+8 more)

### Community 15 - "Categories/Triage Repository"
Cohesion: 0.06
Nodes (32): CopyPlaylistButton(), CopyPlaylistButtonProps, PlaylistPlayerPanelProps, PlaylistTrackRow(), PlaylistTrackRowProps, PlaylistTrackRowView(), ViewProps, PlaylistTracksList() (+24 more)

### Community 16 - "Frontend Auth Provider"
Cohesion: 0.11
Nodes (16): _handle_delete_tag(), _handle_remove_track_tag(), _no_content(), _tags_factory(), Aurora Data API repository for spec-C categories.  Tenancy: every method takes `, NameConflictError, NotFoundError, TagNameConflictError (+8 more)

### Community 17 - "Frontend API Errors & Types"
Cohesion: 0.03
Nodes (30): tokenStore, BLOCK, TRACK, handlers, PLAYLIST_DEFAULTS, server, testTheme, seedPlaylists (+22 more)

### Community 18 - "Vendor Stubs (Apple/Deezer)"
Cohesion: 0.05
Nodes (56): ArtistDetail, ArtistHistoryCell, ArtistHistoryResponse, ArtistsListResponse, BacklogArtist, BacklogResponse, EnrichBody, EnrichmentOptions (+48 more)

### Community 19 - "Backend Error Hierarchy"
Cohesion: 0.06
Nodes (29): ArtistEnrichmentRepository, _normalize_name(), _pg_text_array(), Mirror merged.ai_content into clouder_artists.is_ai_suspected when confidence >=, Return decoded merged ArtistInfo for a user-facing detail page.          When `c, Admin runs list, sorted by created_at DESC., Per-cell breakdown for a run. Joined with clouder_artists for artist_name., Per-artist enrichment history. (+21 more)
...
Cohesion: 0.12
Nodes (21): CurateSkeleton(), ResumeSession, clearLastCurateLocation(), CurateLocation, isStaleLocation(), readLastCurateLocation(), readLastCurateStyle(), readStorage() (+13 more)

### Community 23 - "Storage & Ingest Schemas"
Cohesion: 0.21
Nodes (8): BeatportClient, is_retryable_status(), Beatport API client with pagination and retry semantics., _url_hash(), UpstreamUnavailableError, test_fetch_weekly_releases_rejects_malformed_next_link(), test_fetch_weekly_releases_uses_tracks_endpoint_and_next_pagination(), test_retryable_status_matrix()

### Community 24 - "Playlists Repository"
Cohesion: 0.07
Nodes (25): CurateSession(), CurateSessionProps, DestinationGrid(), DestinationGridProps, ForceToggle(), ForceToggleProps, DIGIT_CODES, BUCKETS (+17 more)

### Community 25 - "Artist Auto-Dispatch Worker"
Cohesion: 0.04
Nodes (63): _build_artist_repository(), _build_auto_repository(), _build_data_api(), _build_sqs_client(), _dispatch_artists(), _queue_url(), Best-effort auto-enrichment dispatch for artists from curation actions.  Mirror, AutoEnrichRepository (+55 more)
...
Cohesion: 0.12
Nodes (9): Pure helpers for spec-D triage. No DB access here., validate_block_input(), validate_target_for_transfer(), validate_track_ids(), Pure-Python helpers for spec-D triage (no DB)., TestBucketConstants, TestValidateBlockInput, TestValidateTargetForTransfer (+1 more)

### Community 28 - "Home Dashboard UI"
Cohesion: 0.06
Nodes (38): ArtistSummary, LabelSummary, ArtistsTable(), Props, LabelChannelLinks(), LabelDetailHeader(), LabelPreferenceButtons(), Props (+30 more)
...
Cohesion: 0.05
Nodes (62): Structured logging helpers with sensitive data redaction., redact_sensitive_data(), _sanitize_event(), _sanitize_fields(), _build_alembic_database_url(), lambda_handler(), Lambda handler that executes Alembic migrations against Aurora., _rds_client() (+54 more)

### Community 31 - "Enrichment Orchestrator"
Cohesion: 0.09
Nodes (53): UpsertVendorTokenCmd, AuthSettings, get_auth_settings(), _parse_csv(), Auth Lambda settings + secret resolution., resolve_jwt_signing_key(), resolve_oauth_client_credentials(), resolve_ytmusic_oauth_credentials() (+45 more)
...
Cohesion: 0.04
Nodes (40): ActiveBlocksList(), ActiveBlocksListProps, CountersGrid(), CountersGridProps, HomeSkeleton(), NoStylesEmpty(), ResumeHero(), ResumeHeroProps (+32 more)

### Community 35 - "Community 35"
Cohesion: 0.07
Nodes (19): Apple export stub — raises VendorDisabledError until implemented., AppleLookup, Apple lookup stub — raises VendorDisabledError until implemented., Raised when a registry lookup cannot be served. The .reason attribute     discri, VendorDisabledError, Deezer export stub — raises VendorDisabledError until implemented., DeezerLookup, Deezer lookup stub — raises VendorDisabledError until implemented. (+11 more)
...
Cohesion: 0.08
Nodes (61): Canonicalization workflow for Beatport entities., AdminRequiredError, ValidationError, EnqueueResult, _IngestParams, _parse_collect_request(), Inputs for `_run_beatport_ingest`.      Three valid field combinations:     - Le, CanonicalizationResult (+53 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (34): call(), CallOptions, ensureOk(), PlayArgs, SeekArgs, spotifyApi, TransferArgs, AuthProvider() (+26 more)

### Community 39 - "Community 39"
Cohesion: 0.19
Nodes (18): test_build_report_no_aggregated_section_when_merged_dir_absent(), test_build_report_renders_aggregated_section(), test_build_report_renders_sections(), _write_cell(), _write_manifest(), _write_merged(), Regenerate the report from an existing run directory., report() (+10 more)
...
Cohesion: 0.14
Nodes (21): mart_sql(), Sessionization rollup SQL for the analytics v2 marts.  One SQL source, two diale, SQL selecting one row per derived session (fact_session grain)., SQL selecting one row per (user_id, dt, activity_type) — mart_user_daily grain., Shared classified→events→gapped→sessioned CTE block (no leading WITH)., create_default_athena_client(), create_default_s3_client(), _delete_partition() (+13 more)
...
Cohesion: 0.06
Nodes (25): AuthRepository, _b64d(), _b64d_optional(), _b64e(), Aurora Data API repository for users / sessions / vendor tokens.  Bytea columns, SessionRow, _to_session_row(), _to_user_row() (+17 more)
...
Cohesion: 0.07
Nodes (34): BucketBadge(), BucketBadgeProps, BucketCard(), BucketCardMode, BucketCardProps, BucketDistributeButtons(), BucketDistributeButtonsProps, BucketGrid() (+26 more)
...
Cohesion: 0.07
Nodes (33): BucketPlayerPanel(), BucketPlayerPanelProps, BucketTrackRow(), BucketTrackRowProps, track, BucketTracksList(), BucketTracksListProps, CurateCard() (+25 more)
...
Cohesion: 0.07
Nodes (13): Load and validate fixtures.yaml., AISignal, FixturesFile, GroundTruth, Data models for the artist sandbox., artist_v1 — facts-discipline + disambiguation + AI detection., _make_prompt(), test_registry_register_and_get() (+5 more)

### Community 54 - "Community 54"
Cohesion: 0.06
Nodes (43): DataAPIClient, _from_field(), Thin wrapper over AWS RDS Data API., Retry wrapper for RDS Data API transient errors.  Aurora Serverless v2 with min_, _to_field(), _to_parameter(), _to_rows(), DataAPIClient (+35 more)

### Community 55 - "Community 55"
Cohesion: 0.14
Nodes (13): StorageError, S3Storage, FakeS3Client, _meta(), Tests for S3Storage: write_run_artifacts and read_releases., test_base_key_pads_week_number(), test_read_releases_decompresses_and_parses(), test_read_releases_filters_non_dict_items() (+5 more)

### Community 56 - "Community 56"
Cohesion: 0.29
Nodes (9): _ctx(), _event(), FakeRepo, _install(), Integration tests for GET /tracks/spotify-not-found date filters., test_not_found_bad_date_400(), test_not_found_from_after_to_400(), test_not_found_passes_date_range() (+1 more)
...
Cohesion: 0.05
Nodes (46): BacklogLabel, BacklogResponse, EnrichBody, EnrichmentOptions, LabelHistoryCell, LabelHistoryResponse, LabelsListResponse, RunsListResponse (+38 more)
...
Cohesion: 0.18
Nodes (17): _beatport_track_row(), _make_data_api(), _make_repo(), When tags_repo is omitted, tags field defaults to empty tuple., test_create_inserts_row_and_returns_playlist(), test_create_raises_limit_reached_at_200(), test_create_translates_unique_violation_to_name_conflict(), test_get_filters_soft_deleted() (+9 more)

### Community 63 - "Community 63"
Cohesion: 0.27
Nodes (13): _ctx(), _event(), FakeRepo, FakeSqs, _install(), Integration tests for POST /admin/spotify/retry-not-found., test_retry_db_not_configured_503(), test_retry_requires_admin() (+5 more)

### Community 64 - "Community 64"
Cohesion: 0.09
Nodes (19): AuthContext, BpTokenInput(), fmt(), IngestForm(), Props, UserMenu(), IngestInput, IngestResponse (+11 more)
...
Cohesion: 0.06
Nodes (43): LabelDetail, Action, AuthState, CallbackResponse, getAuthSnapshot(), Me, RefreshResponse, snapshot (+35 more)
...
Cohesion: 0.06
Nodes (38): EntityTabs(), Props, FinalizeModal(), LibraryFilters(), Props, StyleOption, StyleSelector(), StyleSelectorProps (+30 more)
...
Cohesion: 0.22
Nodes (6): FakeYT, test_isrc_lookup_always_none(), test_metadata_falls_back_to_videos_when_songs_empty(), test_metadata_skips_results_without_video_id(), test_metadata_uses_songs_pass_first(), YTMusicLookup
...
Cohesion: 0.13
Nodes (19): merge_cells(), Merge vendor cells into a single LabelInfo with DeepSeek narrative synthesis., aggregate(), build_deepseek_client(), build_vendors(), list_fixtures(), list_vendors(), _parse_csv() (+11 more)
...
Cohesion: 0.03
Nodes (81): CoverPicker(), CoverPickerProps, DriftBadge(), DriftTarget, EmptyState(), EmptyStateProps, FullScreenLoader(), editDescriptionSchema (+73 more)
...
Cohesion: 0.23
Nodes (4): CategoriesRepository, CategoryRow, Insert (track, source_triage_block_id) pairs idempotently.          Used by both, Add one track to a category. Idempotent on (category_id, track_id).          Ret
...
Cohesion: 0.11
Nodes (29): Unit tests for PlaylistsRepository.  DataAPIClient is stubbed with a MagicMock t, Regression: same Data API constraint as scope-check — the dedup SELECT     insid, If multiple clouder_tracks rows share spotify_id (legitimate prod     state), up, Status flip is organizational, not Spotify-visible — must not mark drift., Regression: Aurora Data API failed status-only patches with     `could not deter, list_tracks with tags_repo attaches artists, label, bpm, mix_name,     spotify_r, test_append_tracks_dedups_against_existing(), test_append_tracks_rejects_when_over_limit() (+21 more)
...
Cohesion: 0.07
Nodes (30): AddTracksModal(), AddTracksModalProps, mutateAsync, PublishButton(), PublishButtonProps, mutateAsync, playlist, RESULT (+22 more)
...
Cohesion: 0.21
Nodes (16): _utc_now(), _utc_now(), _source_entity_cmd(), Record a terminal 'no match found' outcome so the read surface can         retur, datetime, SessionRow, _event(), _refresh_jwt() (+8 more)
...
Cohesion: 0.06
Nodes (31): Admin gate, AI flag propagation rules, AI Search Worker (`collector.search_handler`), Alembic invocation, API Lambda (`collector.handler`), Auth Handler, Auth modes, Deadline-aware execution (+23 more)

### Community 144 - "Community 144"
Cohesion: 0.09
Nodes (15): PlaylistNameConflictError, PlaylistNotFoundError, AppendTracksResult, PlaylistRow, PlaylistTrackRow, Aurora Data API repository for playlists (spec 2026-05-11).  Tenancy: every meth, Partial update. None values mean "leave as is".          If the row is already p, Per-track YT Music status. matched > needs_review > not_found > pending. (+7 more)
...
Cohesion: 0.06
Nodes (40): CellDetailDrawer(), Props, CoverageMatrix(), Props, COLORS, CoverageMatrixCell, Props, Props (+32 more)
...
Cohesion: 0.10
Nodes (22): normalize_playlist_name(), parse_spotify_ref(), Lowercase + trim + collapse internal whitespace., Return the 22-char Spotify track ID or raise InvalidSpotifyRefError.      Accept, validate_description(), validate_playlist_name(), test_normalize_lowercases_trims_collapses(), test_normalize_unicode_emoji() (+14 more)
...
Cohesion: 0.15
Nodes (22): UpsertVendorMatchCmd, Decimal, _clear_all_caches(), _event(), FakeLookup, FakeRepo, _install_fake_spotify(), End-to-end vendor_match_worker flow — fake providers + fake repository.  Covers (+14 more)
...
Cohesion: 0.04
Nodes (49): AddToPlaylistSubmenu(), AddToPlaylistSubmenuProps, ArtistsPanel(), PanelArtist, Props, CategoryPlayerPanel(), CategoryPlayerPanelProps, CommentsPanel() (+41 more)
...
Cohesion: 0.15
Nodes (18): Clear spotify_searched_at for not-found tracks in the publish-date         range, first_saturday(), _last_saturday_on_or_before(), Saturday-anchored week math.  Convention used by the admin Beatport ingest UI., saturday_week_range(), week_of_date(), weeks_in_year(), date (+10 more)
...
Cohesion: 0.11
Nodes (19): API Gateway 29-second hard timeout, Aurora IAM auth flag may not stick via Terraform, AWS resource prefix is `beatport-prod-*`, Behavioural Surprises, `bp_token` must never be logged or stored, Concurrency and SQS, Data API at runtime, psycopg only for migrations, `GET /runs/{run_id}` returns 503 `db_not_configured` (+11 more)
...
Cohesion: 0.11
Nodes (17): categories, category_tracks, Data model, Domain map, Identity map, ingest_runs, Multi-tenant overlay model, playlists / playlist_tracks (+9 more)
...
Cohesion: 0.07
Nodes (15): MatchFailedError, Worker-internal non-fatal: trigger review queue routing. Not an AppError., UserTokenMissingError, VendorAuthError, VendorQuotaError, VendorUnavailableError, Exception, Vendor error class tests (Plan 4 Task 2). (+7 more)
...
Cohesion: 0.40
Nodes (3): The handler maps CurationError -> HTTP envelope. Upstream/server failures (http_, test_curation_error_response_logs_5xx_with_status_and_reason(), test_curation_error_response_logs_5xx_without_status_reason_attrs()
...
Cohesion: 0.26
Nodes (11): _category_exists(), _FakeDataAPI, Tests for fresh=true + used_in_playlist projection in list_tracks., Stub DataAPIClient that records every SQL invocation., Regression guard for the prod 500 on 2026-05-14.      The EXISTS sub-select in t, _row(), test_list_tracks_fresh_combines_with_search_and_tags(), test_list_tracks_fresh_false_default_no_filter() (+3 more)
...
Cohesion: 0.14
Nodes (22): _make_grounding_chunk(), _mock_response(), Tests for GeminiFlashAdapter using injected fake clients., 503 UNAVAILABLE errors are retried with exponential backoff., Quota errors are retried; success on the third attempt counts as ok., When grounding_metadata has no URLs, copy parsed.sources into citations., test_run_bad_json(), test_run_exception_path() (+14 more)
...
Cohesion: 0.03
Nodes (93): merge_cells(), Merge vendor cells into a single ArtistInfo with DeepSeek narrative synthesis., ArtistEnrichmentMessage, EnrichArtistsRequestIn, SQS message schema for artist enrichment (HTTP request models added in 1B)., Body of one SQS message — one per artist, one Lambda invocation.      The disamb, POST /admin/artists/enrich body., build_adapters_from_run_config() (+85 more)

### Community 251 - "Community 251"
Cohesion: 0.20
Nodes (6): Data, Operations, CLOUDER, Features, For developers, License
...
Cohesion: 0.09
Nodes (25): EnrichArtistInput, AISignal, BaseModel, AddTrackIn, AddTracksIn, CoverUploadUrlIn, CreateCategoryIn, CreatePlaylistIn (+17 more)
...
Cohesion: 0.28
Nodes (14): _client(), HTTP-shaped unit tests for the user-OAuth Spotify Web API client.  `requests` is, _Resp, test_401_propagates_as_not_authorized(), test_403_insufficient_scope_propagates(), test_404_propagates_as_not_found(), test_429_persistent_raises_rate_limited(), test_429_with_retry_after_retries_then_succeeds() (+6 more)

### Community 265 - "Community 265"
Cohesion: 0.22
Nodes (6): BeatportProvider, BeatportProvider — IngestProvider adapter over BeatportClient., Thin adapter — delegates everything to BeatportClient.      Exists so handlers d, Unit tests for the BeatportProvider adapter., test_beatport_provider_delegates_to_client(), test_beatport_provider_implements_protocol()
...
Cohesion: 0.23
Nodes (10): _event(), fake_repo(), End-to-end Playlists flow with in-memory repository.  Mirrors the pattern from t, When cover upload fails during publish, the playlist stays     needs_republish=T, test_cover_upload_lifecycle(), test_full_lifecycle(), test_import_spotify_then_publish(), test_publish_cover_failure_keeps_dirty() (+2 more)
...
Cohesion: 0.23
Nodes (9): ImportSpotifyModal(), ImportSpotifyModalProps, RefValidation, validateRefs(), ImportSpotifyInput, useImportSpotifyTracks(), ImportSpotifyResult, InvalidSpotifyRefError (+1 more)
...
Cohesion: 0.06
Nodes (40): api(), ApiError, CategoriesList(), CategoriesListProps, CategoryFormDialog(), CategoryFormDialogProps, CategoryFormMode, CategoryRow() (+32 more)
...
Cohesion: 0.08
Nodes (30): handleFinalizeError(), useAddTrackToCategory(), useBucketDistribute(), UseBucketDistributeArgs, bucketTracksKey(), Action, CurateStatus, initialState (+22 more)
...
Cohesion: 0.20
Nodes (8): Admin gating, Feature-folder convention, Frontend Features Reference, `requireAdmin` loader, `requireAuth` loader, Routing, Vite proxy, Frontend
...
Cohesion: 0.09
Nodes (27): EnvelopePayload, KmsEnvelope, KMS envelope encryption with AES-GCM and a 5-min in-memory data-key cache., Wraps KMS GenerateDataKey/Decrypt with AES-GCM and a small TTL cache., _build_ytmusic_user_client(), Build a YouTube Data API v3 client bound to the user's OAuth token.      Token r, _b64d(), _b64e() (+19 more)
...
Cohesion: 0.05
Nodes (43): useBucketPlayerQueue(), lastDeviceStore, transition(), clampMs(), pctToMs(), findNextPlayable(), PlayableTrack, resolvePlaybackSource() (+35 more)
...
Cohesion: 0.29
Nodes (7): Canonical layer, clouder_albums, clouder_artists, clouder_labels, clouder_styles, clouder_track_artists, clouder_tracks
...
Cohesion: 0.22
Nodes (8): API Lambda (`beatport-prod-collector-api`), Aurora PostgreSQL logs, Canonicalization worker (`beatport-prod-canonicalization-worker`), Logs, Migration Lambda (`beatport-prod-db-migration`), Spotify search worker (`beatport-prod-spotify-search-worker`), Structlog events, Tailing Lambda logs
...
Cohesion: 0.33
Nodes (6): _by_key(), _mart(), _sessions(), test_fact_session_metrics(), test_fixture_loads_and_sql_runs(), test_mart_user_daily()
...
Cohesion: 0.25
Nodes (7): AI search worker (`beatport-prod-ai-search-worker`), API and worker Lambda (`beatport-prod-collector-api`), Environment Variables Reference, Migration Lambda (`beatport-prod-db-migration`), Spotify search worker (`beatport-prod-spotify-search-worker`), Vendor match worker (`beatport-prod-vendor-match-worker`), `VENDORS_ENABLED`
...
Cohesion: 0.29
Nodes (7): Metadata fallback, Perplexity label and artist screening, Result schema, Search and enrichment, Sibling ISRC neighbour matching, Spotify ISRC lookup, Vendor match cache
...
Cohesion: 0.29
Nodes (7): Analytics first run (bootstrap), Cold-start 503, DLQ messages, Lambda reserved concurrency trip, `processing_status=FAILED_TO_QUEUE`, Refresh-cookie replay revocation, Runbook
...
Cohesion: 0.40
Nodes (5): Canonicalization Worker (`collector.worker_handler`), Idempotency, Processing flow, Retry and DLQ behavior, Trigger
...
Cohesion: 0.50
Nodes (4): CLOUDER Architecture, Subsystems, System overview, Where to read next

### Community 403 - "Community 403"
Cohesion: 0.40
Nodes (3): AutoEnrichConfigIn, PUT body schema for auto-enrichment config., PUT /admin/auto-enrich/labels body.      When `enabled` is False the model/promp
...
Cohesion: 0.13
Nodes (15): PlaylistsRepository, Exposed for collaborators that need read access to other tables         from ins, Persist publish-state.          When ``mark_dirty`` is True we still record the, Record the YouTube Music playlist id + publish timestamp and clear         the y, Idempotent import: returns canonical clouder_tracks.id.          Two branches:, test_set_cover_updates_row_and_marks_dirty(), FakeDataAPI, test_fetch_unmatched_excludes_already_attempted_in_sql() (+7 more)
...
## Knowledge Gaps
- **2475 isolated node(s):** `Problem`, `Goals`, `Non-goals`, `Backend`, `Frontend` (+2470 more)
...
- **Why does `log_event()` connect `Curation API Handler` to `Playlists UI`, `API Route Handlers (admin/enrich)`, `KMS Envelope & Auth Crypto`, `Library Artist/Label UI`, `Community 138`, `Enrichment Data Models`, `Frontend Auth Provider`, `Storage & Ingest Schemas`, `Artist Auto-Dispatch Worker`, `Admin Backlog UI`, `Provider Protocols`, `Auto-Enrich Repository`, `Enrichment Orchestrator`, `Community 163`, `Community 37`, `Community 44`, `Community 304`, `Community 305`, `Community 181`, `Community 54`, `Community 55`, `Community 439`, `Community 189`, `Community 73`, `Community 75`, `Community 80`, `Community 217`, `Community 91`, `Community 219`, `Community 358`, `Community 235`, `Community 250`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `PlaylistsRepository` connect `Community 406` to `Curation API Handler`, `Community 385`, `Community 129`, `Community 541`, `Community 453`, `Library Artist/Label UI`, `Community 168`, `Community 144`, `Frontend Auth Provider`, `Community 54`, `Artist Auto-Dispatch Worker`, `Provider Protocols`, `Community 62`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `api()` connect `Community 292` to `Admin Coverage/Enrich UI`, `Community 133`, `Curation Error Types`, `Categories/Triage Repository`, `Frontend API Errors & Types`, `Vendor Stubs (Apple/Deezer)`, `Community 275`, `Community 152`, `Home Dashboard UI`, `Community 34`, `Community 164`, `Community 293`, `Community 294`, `Community 42`, `Community 49`, `Community 60`, `Community 190`, `Community 64`, `Community 68`, `Community 197`, `Community 70`, `Community 77`, `Community 78`, `Community 88`, `Community 234`?**
