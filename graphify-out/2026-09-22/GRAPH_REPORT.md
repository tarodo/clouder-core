...
- `test_build_adapters_forwards_openai_knobs()` --calls--> `LabelEnrichmentSecrets`  [INFERRED]
  tests/unit/test_label_enrichment_orchestrator.py → src/collector/label_enrichment/settings_provider.py
- `test_build_adapters_from_run_config_returns_three_adapters()` --calls--> `LabelEnrichmentSecrets`  [INFERRED]
  tests/unit/test_label_enrichment_orchestrator.py → src/collector/label_enrichment/settings_provider.py
- `test_build_adapters_rejects_unknown_vendor()` --calls--> `LabelEnrichmentSecrets`  [INFERRED]
  tests/unit/test_label_enrichment_orchestrator.py → src/collector/label_enrichment/settings_provider.py
...
Cohesion: 0.07
Nodes (94): Any, _extract_user_id(), handle_put_auto_config(), _build_repository(), _build_sqs_client(), _extract_user_id(), handle_get_artist(), handle_get_artist_history() (+86 more)
...
Cohesion: 0.10
Nodes (24): DriftBadge(), DriftTarget, usePlaylistDetail(), usePlaylistPlayerQueue(), usePlaylistTracks(), AddVars, Ctx, RemoveVars (+16 more)
...
Cohesion: 0.09
Nodes (22): BacklogResponse, LabelHistoryCell, LabelHistoryResponse, LabelsListResponse, RunCell, RunDetail, RunsListResponse, RunSummary (+14 more)

### Community 13 - "Admin Artist API Types"
Cohesion: 0.05
Nodes (27): ClouderRepository, Read-only peek used to decide whether a follow-up batch is needed.          Must, Copy release_type from tracks onto their parent albums.          Runs a single U, UpdateSpotifyResultCmd, utc_now(), Pydantic schemas for external input boundaries., SpotifySearchMessage, _enqueue_follow_up_if_needed() (+19 more)
...
Cohesion: 0.07
Nodes (37): _build_merge_client(), lambda_handler(), _build_narrative_prompt(), _filter_parseable(), _highest_confidence_cell(), merge_cells(), _merge_deterministic(), _merge_narrative() (+29 more)

### Community 26 - "Admin Backlog UI"
Cohesion: 0.24
Nodes (9): PlaylistRow(), PlaylistRowProps, StatusBadge(), StatusBadgeProps, UsePlaylistsOpts, ToggleStatusInput, useTogglePlaylistStatus(), PaginatedPlaylists (+1 more)
...
Cohesion: 0.11
Nodes (21): editDescriptionSchema, FormValues, PlaylistFormDialog(), PlaylistFormDialogProps, PlaylistFormMode, renameSchema, PlaylistMetaPanel(), useCreatePlaylist() (+13 more)
...
Cohesion: 0.05
Nodes (53): AppleExporter, Apple export stub — raises VendorDisabledError until implemented., AppleLookup, Apple lookup stub — raises VendorDisabledError until implemented., Raised when a registry lookup cannot be served. The .reason attribute     discri, VendorDisabledError, DeezerExporter, Deezer export stub — raises VendorDisabledError until implemented. (+45 more)

### Community 36 - "Community 36"
Cohesion: 0.08
Nodes (27): PlaylistMetaPanelProps, PlaylistsTable(), PlaylistsTableProps, PublishButton(), PublishButtonProps, mutateAsync, playlist, RESULT (+19 more)
...
Cohesion: 0.09
Nodes (28): Per (beatport style, Saturday week of publish_date) Spotify-match         counts, Clear spotify_searched_at for not-found tracks in the publish-date         range, first_saturday(), _last_saturday_on_or_before(), Saturday-anchored week math.  Convention used by the admin Beatport ingest UI., saturday_week_range(), week_of_date(), weeks_in_year() (+20 more)
...
Cohesion: 0.07
Nodes (35): StorageError, S3 persistence for weekly snapshots., S3Storage, _enqueue_spotify_search_after_canonicalization(), _extract_message_attribute(), SQS worker that canonicalizes Beatport raw data., Enqueue Spotify ISRC search after canonicalization completes., Browser may upload PNG instead of JPEG; the presign must reflect     whatever co (+27 more)
...
Cohesion: 0.15
Nodes (14): BacklogLabel, PageHeader(), PageHeaderProps, BacklogTable(), Props, BacklogToolbar(), Props, StyleFilterOption (+6 more)
...
Cohesion: 0.10
Nodes (30): UpsertVendorMatchCmd, VendorTrackMatch, VendorMatchMessage, _process_one(), SQS-triggered worker that matches a canonical track to a vendor., _try_isrc(), _try_metadata(), Decimal (+22 more)
...
Cohesion: 0.14
Nodes (18): LabelPreferenceButtons(), Props, LabelInfoView, LabelTile(), pickPreference(), Props, labelInfoKey(), useLabelInfo() (+10 more)
...
Cohesion: 0.09
Nodes (25): api(), ApiInit, notifyAuthFailure(), RefreshResponse, tryRefreshOnce(), CoverPicker(), CoverPickerProps, SpotifyNotFoundTable() (+17 more)
...
Cohesion: 0.14
Nodes (20): _event(), fake_repo(), End-to-end Playlists flow with in-memory repository.  Mirrors the pattern from t, Regression for I1: a bad/inaccessible Spotify playlist must surface     the rout, Regression for I2: if anything after repo.create() fails, the     just-created p, When cover upload fails during publish, the playlist stays     needs_republish=T, GET /playlists/{id}/export returns the full copy payload in one call., test_cover_upload_lifecycle() (+12 more)
...
Cohesion: 0.07
Nodes (23): ArtistContext, Disambiguation context from the artist's tracks: dominant style,         up to 3, SocialsResult, FakeAutoRepo, FakeRepo, test_handler_enriches_one_artist(), FakeMergeClient, FakeRepo (+15 more)
...
Cohesion: 0.07
Nodes (38): CopyPlaylistButton(), CopyPlaylistButtonProps, PlaylistPlayerPanelProps, PlaylistTrackRow(), PlaylistTrackRowProps, PlaylistTrackRowView(), ViewProps, PlaylistTracksList() (+30 more)
