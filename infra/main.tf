locals {
  ...
  vendor_match_worker_lambda_name     = "${local.name_prefix}-vendor-match-worker"
  vendor_match_queue_name             = "${local.name_prefix}-vendor-match"
  vendor_match_dlq_name               = "${local.name_prefix}-vendor-match-dlq"
